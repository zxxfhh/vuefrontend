...
export const GetDataChartBy = (data?: QueryTableParams) => {
  ...
  return http.request<Result>("post", "/EventReportDay/GetSubDataChartBy", {
    data
  });
};
...
export const GetDataTableBy = (data?: QueryTableParams) => {
  ...
  return http.request<Result>("post", "/EventReportDay/GetSubDataTableBy", {
    data
  });
};
...
export const GetSubDataTableExcelBy = (data?: QueryTableParams) => {
  ...
  return http.request<Result>(
    "post",
    "/EventReportDay/GetSubDataTableExcelBy",
    {
      data
    }
  );
