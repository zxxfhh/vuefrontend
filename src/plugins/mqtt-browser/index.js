  ...
  })(
    {
        ...
        function (e, t, r) {
          (function (t, n) {
            (function () {
              ...
              Object.defineProperty(r, "__esModule", { value: !0 });
              const l = a(e("./topic-alias-recv")),
                u = a(e("mqtt-packet")),
                c = a(e("./default-message-id-provider")),
                h = e("readable-stream"),
                f = a(e("reinterval")),
                d = a(e("rfdc/default")),
                p = o(e("./validations")),
              ...
              class E extends y.TypedEventEmitter {
                ...
                constructor(e, t) {
                  ...
                  for (const e in v)
                    void 0 === this.options[e]
                      ...
                      : (this.options[e] = t[e]);
                  ((this.log =
                    this.options.log || (0, b.default)("mqttjs:client")),
                    (this.noop = this._noop.bind(this)),
                    this.log("MqttClient :: options.protocol", t.protocol),
                    this.log(
                      "MqttClient :: options.protocolVersion",
                      t.protocolVersion
                    ),
                    this.log("MqttClient :: options.username", t.username),
                    this.log("MqttClient :: options.keepalive", t.keepalive),
                    this.log(
                    ...
                    this.log(
                      ...
                      t.properties ? t.properties.topicAliasMaximum : void 0
                    ),
                    ...
                    this.options.writeCache ||
                      (u.default.writeToStream.cacheNumbers = !1),
                    (this.streamBuilder = e),
                    (this.messageIdProvider =
                      void 0 === this.options.messageIdProvider
                        ? new c.default()
                        : this.options.messageIdProvider),
                    (this.outgoingStore = t.outgoingStore || new g.default()),
                    (this.incomingStore = t.incomingStore || new g.default()),
                    (this.queueQoSZero =
                    ...
                    t.properties &&
                      ...
                      (t.properties.topicAliasMaximum > 65535
                        ? this.log(
                            "MqttClient :: options.properties.topicAliasMaximum is out of range"
                          )
                        : (this.topicAliasRecv = new l.default(
                    ...
                    this.on("close", () => {
                      (this.log("close :: connected set to `false`"),
                        ...
                        null !== this.pingTimer &&
                          (this.pingTimer.clear(), (this.pingTimer = null)),
                ...
                connect() {
                  var e;
                  const t = new h.Writable(),
                    r = u.default.parser(this.options);
                  let n = null;
                  const i = [];
                  ...
                  if (
                    (this.options.will &&
                      (a.will = Object.assign(
                        Object.assign({}, this.options.will),
                        {
                          payload:
                            null === (e = this.options.will) || void 0 === e
                              ? void 0
                              : e.payload
                        }
                      )),
                ...
                publish(e, t, r, n) {
                  ...
                  const c = () => {
                    ...
                    switch (
                      (5 === i.protocolVersion && (c.properties = l),
                      this.log("publish :: qos", s),
                      s)
                    ) {
                      case 1:
                      case 2:
                        ((this.outgoing[c.messageId] = {
                          volatile: !1,
                          cb: n || this.noop
                        }),
                          this.log("MqttClient:publish: packet cmd: %s", c.cmd),
                          this._sendPacket(c, void 0, u));
                        break;
                      default:
                        (this.log("MqttClient:publish: packet cmd: %s", c.cmd),
                          this._sendPacket(c, n, u));
                    }
                    return !0;
                  };
                  return (
                ...
                publishAsync(e, t, r) {
                  return new Promise((n, i) => {
                    this.publish(e, t, r, e => {
                      e ? i(e) : n();
                    });
                  });
                }
                subscribe(e, t, r) {
                  const n = this.options.protocolVersion;
                  ...
                  "string" == typeof e
                    ...
                    : Array.isArray(e)
                      ...
                      : "object" == typeof e &&
                        ...
                        (s = Object.keys(e)));
                  const o = p.validateTopics(s);
                  if (null !== o)
                    return (w(r, new Error(`Invalid topic ${o}`)), this);
                  if (this._checkDisconnecting(r))
                    return (this.log("subscribe: discconecting true"), this);
                  const a = { qos: 0 };
                  5 === n && ((a.nl = !1), (a.rap = !1), (a.rh = 0));
                  const l = (t = Object.assign(Object.assign({}, a), t))
                      .properties,
                    u = [],
                    c = (e, r) => {
                      if (
                  ...
                  if (
                    (Array.isArray(e)
                      ? e.forEach(e => {
                          (this.log("subscribe: array topic %s", e), c(e));
                        })
                      ...
                      (u.forEach(t => {
                        if (this.options.reconnectPeriod > 0) {
                          ...
                          (5 === n &&
                            ...
                            (this._resubscribeTopics[t.topic] = r),
                            e.push(t.topic));
                        }
                      }),
                ...
                unsubscribe(e, t, r) {
                  ("string" == typeof e && (e = [e]),
                    ...
                    (r = r || this.noop));
                  const n = p.validateTopics(e);
                  if (null !== n)
                    return (w(r, new Error(`Invalid topic ${n}`)), this);
                ...
                reconnect(e) {
                  ...
                  const t = () => {
                    (e
                      ...
                      (this.incomingStore =
                        this.options.incomingStore || new g.default()),
                      (this.outgoingStore =
                        this.options.outgoingStore || new g.default()),
                      (this.disconnecting = !1),
                      (this.disconnected = !1),
                ...
                _removeTopicAliasAndRecoverTopicName(e) {
                  ...
                  if (
                    ...
                    if (
                      ((r = this.topicAliasSend.getTopicByAlias(t)),
                      void 0 === r)
                    )
                      return new Error("Unregistered Topic Alias");
                    e.topic = r;
                ...
                _cleanUp(e, t, r = {}) {
                  if (
                    ...
                    const e = Object.assign({ cmd: "disconnect" }, r);
                    (this.log(
                ...
                _writePacket(e, t) {
                  ...
                  const r = u.default.writeToStream(
                    e,
                    this.stream,
                    this.options
                  );
                ...
                _sendPacket(e, t, r, n) {
                  (this.log(
                    ...
                    (r = r || this.noop),
                    (t = t || this.noop));
                  const i = this._applyTopicAlias(e);
                  if (i) t(i);
                  else {
                    if (!this.connected)
                      return "auth" === e.cmd
                ...
                _storePacket(e, t, r) {
                  ...
                  if ("publish" === n.cmd) {
                    n = (0, d.default)(e);
                    const r = this._removeTopicAliasAndRecoverTopicName(n);
                    if (r) return t && t(r);
                  }
                  const i = n.qos || 0;
                ...
                _onConnect(e) {
                  ...
                  const t = () => {
                    ...
                    const s = () => {
                      ...
                      e
                        ? ((this._storeProcessing = !0),
                          this._packetIdsDuringStoreProcessing[e.messageId]
                            ? s()
                            : this.disconnecting || this.reconnectTimer
                              ...
                              : ((t = this.outgoing[e.messageId]
                                ...
                                this.messageIdProvider.register(e.messageId)
                                  ? this._sendPacket(e, void 0, void 0, !0)
                                  : this.log(
                    ...
                    (r.on("end", () => {
                      let r = !0;
                      for (const e in this._packetIdsDuringStoreProcessing)
      ...
      3: [
        function (e, t, r) {
          ...
          r.default = (e, t) => {
            ...
            return (
              (a = t.my),
              a.connectSocket({ url: n, protocols: r }),
              (l = (function () {
                const e = new s.Transform();
                return (
                  (e._write = (e, t, r) => {
                    a.sendSocketMessage({
                      data: e.buffer,
              ...
              c ||
                ...
                a.onSocketMessage(e => {
                  if ("string" == typeof e.data) {
                    const t = i.Buffer.from(e.data, "base64");
                    l.push(t);
                  } else {
        ...
        { buffer: 29, duplexify: 32, "readable-stream": 125 }
      ],
      4: [
        function (e, t, r) {
          "use strict";
          ...
          (Object.defineProperty(r, "__esModule", { value: !0 }),
            (r.connectAsync = void 0));
          const i = n(e("debug")),
            s = n(e("url")),
            o = n(e("../client")),
            a = n(e("../is-browser")),
            l = (0, i.default)("mqttjs"),
            u = {};
          function c(e, t) {
            if (
              (l("connecting to an MQTT broker..."),
              "object" != typeof e || t || ((t = e), (e = "")),
              (t = t || {}),
              e && "string" == typeof e)
            ) {
              const r = s.default.parse(e, !0);
              if (
                (null != r.port && (r.port = Number(r.port)),
                null === (t = Object.assign(Object.assign({}, r), t)).protocol)
              )
            ...
            const r = new o.default(function (e) {
              return (
                t.servers &&
                  ...
                  (t.hostname = t.host),
                  e._reconnectCount++),
                l("calling streambuilder for", t.protocol),
                u[t.protocol](e, t)
              );
            }, t);
            return (r.on("error", () => {}), r);
          ...
          (a.default
            ? ((u.wx = e("./wx").default),
              (u.wxs = e("./wx").default),
              (u.ali = e("./ali").default),
              (u.alis = e("./ali").default))
            : ((u.mqtt = e("./tcp").default),
              (u.tcp = e("./tcp").default),
              (u.ssl = e("./tls").default),
              (u.tls = u.ssl),
              (u.mqtts = e("./tls").default)),
            (u.ws = e("./ws").default),
            (u.wss = e("./ws").default),
            (r.connectAsync = function (e, t, r = !0) {
              return new Promise((n, i) => {
                const s = c(e, t),
                  o = {
                    connect: e => {
      ...
      5: [
        function (e, t, r) {
          ...
          Object.defineProperty(r, "__esModule", { value: !0 });
          const i = n(e("net")),
            s = (0, n(e("debug")).default)("mqttjs:tcp");
          r.default = (e, t) => {
            ((t.port = t.port || 1883),
            ...
            const { port: r } = t,
              n = t.hostname;
            return (
              s("port %d and host %s", r, n),
              i.default.createConnection(r, n)
            );
          };
        },
        { debug: 30, net: 26 }
      ...
      6: [
        function (e, t, r) {
          ...
          const i = n(e("tls")),
            s = n(e("net")),
            o = (0, n(e("debug")).default)("mqttjs:tls");
          r.default = (e, t) => {
            ((t.port = t.port || 8883),
              (t.host = t.hostname || t.host || "localhost"),
              0 === s.default.isIP(t.host) && (t.servername = t.host),
          ...
          r.default = u.default
            ? (e, t) => {
                ...
                const n = (function (e) {
                  ...
                  p = (function (e, t, r) {
                    const n = new l.Transform({ objectMode: e.objectMode });
                    return ((n._write = t), (n._flush = r), n);
                  })(
                    t,
                    function e(t, r, n) {
                      h.bufferedAmount > s && setTimeout(e, o, t, r, n);
                      u &&
                        "string" == typeof t &&
                        (t = i.Buffer.from(t, "utf8"));
                      try {
                        h.send(t);
                      } catch (e) {
                        return n(e);
                ...
                (t.objectMode || (p._writev = w),
                  p.on("close", () => {
                    h.close();
                  }));
                const b = void 0 !== h.addEventListener;
                function g() {
                ...
                function w(e, t) {
                  ...
                  for (let t = 0; t < e.length; t++)
                    "string" == typeof e[t].chunk
                      ? (r[t] = i.Buffer.from(e[t], "utf8"))
                      : (r[t] = e[t].chunk);
                  this._write(i.Buffer.concat(r), "binary", t);
                }
                return (
                  h.readyState === h.OPEN
                    ? (r = p)
                    : ((r = (0, a.default)(void 0, void 0, t)),
                      t.objectMode || (r._writev = w),
                      b ? h.addEventListener("open", g) : (h.onopen = g)),
                  (r.socket = h),
                  b
                    ? (h.addEventListener("close", m),
                      h.addEventListener("error", y),
                      h.addEventListener("message", _))
                    : ((h.onclose = m), (h.onerror = y), (h.onmessage = _)),
                  r
                );
              }
            : (e, t) => {
                ...
                const r = d(t),
                  ...
                  i = (function (e, t, r) {
                    (c("createWebSocket"),
                      c(`protocol: ${r.protocolId} ${r.protocolVersion}`));
                    const n =
                    ...
                    return (
                      c(
                        `creating new Websocket for url: ${t} and protocol: ${n}`
                      ),
                      new s.default(t, [n], r.wsOptions)
                    );
                  })(0, n, r),
                  o = s.default.createWebSocketStream(i, r.wsOptions);
                return (
                  (o.url = n),
                  i.on("close", () => {
                    o.destroy();
      ...
      8: [
        function (e, t, r) {
          ...
          r.default = (e, t) => {
            ...
            ((a = wx.connectSocket({ url: n, protocols: [r] })),
              (l = (function () {
                const e = new s.Transform();
                return (
                  (e._write = (e, t, r) => {
        ...
        function (e, t, r) {
          ...
          r.default = (e, t) => {
            const { messageId: n } = t,
              i = t.cmd;
            let s = null;
            const o = e.outgoing[n] ? e.outgoing[n].cb : null;
            let a;
            if (o) {
              switch ((e.log("_handleAck :: packet type", i), i)) {
                case "pubcomp":
                case "puback": {
                  const i = t.reasonCode;
                  i && i > 0 && 16 !== i
                    ? ((a = new Error(`Publish error: ${r.ReasonCodes[i]}`)),
                      (a.code = i),
                      e._removeOutgoingAndStoreMessage(n, () => {
                        o(a, t);
                      }))
                    : e._removeOutgoingAndStoreMessage(n, o);
                  break;
                }
                case "pubrec": {
                ...
                case "suback": {
                  (delete e.outgoing[n], e.messageIdProvider.deallocate(n));
                  const r = t.granted;
                  for (let t = 0; t < r.length; t++)
                    if (0 != (128 & r[t])) {
                      const t = e.messageIdToTopic[n];
                      t &&
                        t.forEach(t => {
                          delete e._resubscribeTopics[t];
                        });
                    }
                  (delete e.messageIdToTopic[n],
                    e._invokeStoreProcessingQueue(),
                    o(null, t));
                  break;
                }
                case "unsuback":
                  (delete e.outgoing[n],
                    e.messageIdProvider.deallocate(n),
                    e._invokeStoreProcessingQueue(),
                    o(null));
                  break;
                default:
                  e.emit("error", new Error("unrecognized packet type"));
              }
              e.disconnecting &&
                0 === Object.keys(e.outgoing).length &&
                e.emit("outgoingEmpty");
            } else
              e.log("_handleAck :: Server sent an ack in error. Ignoring.");
          };
        },
        {}
      ],
      11: [
        function (e, t, r) {
          ...
          r.default = (e, t) => {
            const { options: r } = e,
              s = r.protocolVersion,
              o = 5 === s ? t.reasonCode : t.returnCode;
            if (5 === s)
              e.handleAuth(t, (t, r) => {
                if (t) e.emit("error", t);
                else if (24 === o) ((e.reconnecting = !1), e._sendPacket(r));
                else {
                  const t = new n.ErrorWithReasonCode(
                    `Connection refused: ${i.ReasonCodes[o]}`,
                    o
                  );
                  e.emit("error", t);
                }
              ...
              const t = new n.ErrorWithReasonCode(
                `Protocol error: Auth packets are only supported in MQTT 5. Your version:${s}`,
                o
              );
              e.emit("error", t);
            }
      ...
      12: [
        function (e, t, r) {
          ...
          Object.defineProperty(r, "__esModule", { value: !0 });
          const i = e("./ack"),
            s = n(e("../topic-alias-send")),
            o = e("../shared");
          r.default = (e, t) => {
            e.log("_handleConnack");
            const { options: r } = e,
              n = 5 === r.protocolVersion ? t.reasonCode : t.returnCode;
            if (
              (clearTimeout(e.connackTimer),
              delete e.topicAliasSend,
              t.properties)
            ) {
              if (t.properties.topicAliasMaximum) {
                ...
                t.properties.topicAliasMaximum > 0 &&
                  (e.topicAliasSend = new s.default(
                    t.properties.topicAliasMaximum
                  ));
              }
              (t.properties.serverKeepAlive &&
                r.keepalive &&
                ((r.keepalive = t.properties.serverKeepAlive),
                e._shiftPingInterval()),
                t.properties.maximumPacketSize &&
                  (r.properties || (r.properties = {}),
                  (r.properties.maximumPacketSize =
                    t.properties.maximumPacketSize)));
            }
            if (0 === n) ((e.reconnecting = !1), e._onConnect(t));
            else if (n > 0) {
              const t = new o.ErrorWithReasonCode(
                `Connection refused: ${i.ReasonCodes[n]}`,
                n
              );
              e.emit("error", t);
            }
        ...
        { "../shared": 17, "../topic-alias-send": 20, "./ack": 10 }
      ],
      13: [
        function (e, t, r) {
          "use strict";
          ...
          r.default = (e, t, r) => {
            ...
            if (
              ...
              n.properties.maximumPacketSize < t.length
            )
              return (
            ...
            switch (
              ...
              case "pingresp":
                ...
                break;
              case "disconnect":
                (e.emit("disconnect", t), r());
                break;
              default:
                (e.log("_handlePacket :: unknown command"), r());
            }
          };
        },
        {
      ...
      14: [
        function (e, t, r) {
          ...
          r.default = (e, t, r) => {
            (e.log("handlePublish: packet %o", t),
              (r = void 0 !== r ? r : e.noop));
            let i = t.topic.toString();
            const s = t.payload,
              { qos: o } = t,
              { messageId: a } = t,
              { options: l } = e;
            if (5 === e.options.protocolVersion) {
              let r;
              if ((t.properties && (r = t.properties.topicAlias), void 0 !== r))
                if (0 === i.length) {
                  if (!(r > 0 && r <= 65535))
                    return (
                      e.log(
                  ...
                  {
                    const t = e.topicAliasRecv.getTopicByAlias(r);
                    if (!t)
                      return (
                        e.log(
            ...
            switch ((e.log("handlePublish: qos %d", o), o)) {
              ...
              case 1:
                  ...
                  (o, l) => (
                    ...
                    o
                      ...
                      : -1 === n.indexOf(l)
                        ...
                        : (l || e.emit("message", i, s, t),
                          void e.handleMessage(t, t => {
                            if (t) return r && r(t);
                            e._sendPacket(
                ...
                break;
              case 0:
                (e.emit("message", i, s, t), e.handleMessage(t, r));
                break;
              default:
            ...
            e.incomingStore.get(t, (t, r) => {
              t
                ...
                : (e.emit("message", r.topic, r.payload, r),
                  e.handleMessage(r, t => {
                    if (t) return n(t);
                    (e.incomingStore.del(r, e.noop), e._sendPacket(s, n));
                  }));
            });
          };
        },
      ...
      17: [
        function (e, t, r) {
          "use strict";
          (Object.defineProperty(r, "__esModule", { value: !0 }),
            (r.applyMixin = r.ErrorWithReasonCode = void 0));
          ...
          ((r.ErrorWithReasonCode = n),
            (r.applyMixin = function (e, t, r = !1) {
              var n;
              const i = [t];
              for (;;) {
                const e = i[0],
                  t = Object.getPrototypeOf(e);
                if (!(null == t ? void 0 : t.prototype)) break;
                i.unshift(t);
              }
              for (const t of i)
                for (const i of Object.getOwnPropertyNames(t.prototype))
                  (r || "constructor" !== i) &&
                    Object.defineProperty(
                      ...
                      i,
                      null !==
                        (n = Object.getOwnPropertyDescriptor(t.prototype, i)) &&
                        void 0 !== n
                        ? n
                        : Object.create(null)
                    );
      ...
      18: [
        function (e, t, r) {
          ...
          r.default = class {
            ...
            createStream() {
              const e = new n.Readable(i),
                t = [];
              let r = !1,
                s = 0;
              return (
                this._inflights.forEach((e, r) => {
                  t.push(e);
                }),
                (e._read = () => {
                  !r && s < t.length ? e.push(t[s++]) : e.push(null);
                }),
                (e.destroy = t => {
                  if (!r)
                    return (
            ...
            del(e, t) {
              const r = this._inflights.get(e.messageId);
              return (
                r
            ...
            get(e, t) {
              const r = this._inflights.get(e.messageId);
              return (
                r ? t(null, r) : t && t(new Error("missing packet")),
                this
              );
            }
            close(e) {
      ...
      20: [
        function (e, t, r) {
          ...
          Object.defineProperty(r, "__esModule", { value: !0 });
          const i = n(e("lru-cache")),
            s = e("number-allocator");
          r.default = class {
            constructor(e) {
              e > 0 &&
                ((this.aliasToTopic = new i.default({ max: e })),
                (this.topicToAlias = {}),
                (this.numberAllocator = new s.NumberAllocator(1, e)),
                (this.max = e),
                (this.length = 0));
            }
            put(e, t) {
            ...
            getLruAlias() {
              ...
              return (
                e || [...this.aliasToTopic.keys()][this.aliasToTopic.size - 1]
              );
            }
          };
        },
        { "lru-cache": 72, "number-allocator": 98 }
      ],
      21: [
        function (e, t, r) {
          "use strict";
          ...
          function n(e) {
            ...
            for (let e = 0; e < t.length; e++)
              if ("+" !== t[e]) {
                ...
                if (-1 !== t[e].indexOf("+") || -1 !== t[e].indexOf("#"))
                  return !1;
              }
            return !0;
          }
          (Object.defineProperty(r, "__esModule", { value: !0 }),
            (r.validateTopics = r.validateTopic = void 0),
            (r.validateTopic = n),
            (r.validateTopics = function (e) {
      ...
      23: [
        function (e, t, r) {
          ...
          (Object.defineProperty(r, "__esModule", { value: !0 }),
            (r.ReasonCodes =
              r.UniqueMessageIdProvider =
              r.DefaultMessageIdProvider =
              r.Store =
              r.MqttClient =
              r.connectAsync =
              r.connect =
          ...
          ((r.connect = f.default),
            Object.defineProperty(r, "connectAsync", {
              enumerable: !0,
              get: function () {
          ...
          Object.defineProperty(r, "ReasonCodes", {
            enumerable: !0,
            get: function () {
        ...
        },
        {
          "./lib/client": 2,
          "./lib/connect": 4,
          "./lib/default-message-id-provider": 9,
          "./lib/handlers/ack": 10,
          "./lib/shared": 17,
          "./lib/store": 18,
          "./lib/unique-message-id-provider": 21
        }
      ],
      24: [
        function (e, t, r) {
          "use strict";
          const { AbortController: n, AbortSignal: i } =
            "undefined" != typeof self
              ? self
              : "undefined" != typeof window
                ? window
      ...
      29: [
              ...
              ((r.kMaxLength = i),
                ...
                (o.concat = function (e, t) {
                  ...
                  for (r = 0; r < e.length; ++r) {
                    var s = e[r];
                    if ((F(s, Uint8Array) && (s = o.from(s)), !o.isBuffer(s)))
                      throw new TypeError(
                        '"list" argument must be an Array of Buffers'
                      );
        ...
        { "base64-js": 25, buffer: 29, ieee754: 50 }
      ],
      30: [
        function (e, t, r) {
          (function (n) {
              ...
              (o(f, i.Duplex),
                ...
                (f.prototype.setReadable = function (e) {
                  if ((this._unread && this._unread(), this.destroyed))
                    ...
                    var t,
                      r = this,
                      n = s(e, { writable: !1, readable: !0 }, c(this)),
                      o = function () {
                        r._forward();
                      },
                      a = function () {
                    ...
                    ((this._drained = !0),
                      ...
                      this._readable2.on("readable", o),
                      this._readable2.on("end", a),
                      (this._unread = function () {
                        (r._readable2.removeListener("readable", o),
      ...
      35: [
        ...
        { "./_stream_transform": 37, inherits: 51 }
      ],
      36: [
        function (e, t, r) {
          (function (r, n) {
              ...
              function T(e, t, r, n, i) {
                ...
                if (null === t)
                  ...
                  if (
                    ...
                    o.endEmitted ? S(e, new v()) : I(e, o, t, !0);
                  else if (o.ended) S(e, new _());
                  else {
              ...
              ((k.prototype.read = function (e) {
                ...
                if (
                  ...
                  return (
                    ...
                    0 === t.length && t.ended ? D(this) : C(this),
                    null
                  );
                ...
                (k.prototype.removeAllListeners = function (e) {
                  ...
                  return (
                    ("readable" !== e && void 0 !== e) || r.nextTick(B, this),
                    t
                  );
                }),
                (k.prototype.resume = function () {
                  ...
                  return (
                    e.flowing ||
                      ...
                      (function (e, t) {
                        t.resumeScheduled ||
                          ((t.resumeScheduled = !0), r.nextTick(j, e, t));
                      })(this, e)),
                    (e.paused = !1),
                    this
                  );
        ...
        },
        {
          "../errors": 33,
          "./_stream_duplex": 34,
          "./internal/streams/async_iterator": 39,
          "./internal/streams/buffer_list": 40,
          "./internal/streams/destroy": 41,
          "./internal/streams/from": 43,
          "./internal/streams/state": 45,
          "./internal/streams/stream": 46,
          _process: 102,
          buffer: 29,
          events: 49,
          inherits: 51,
      ...
      37: [
        ...
        { "../errors": 33, "./_stream_duplex": 34, inherits: 51 }
      ],
      38: [
        function (e, t, r) {
          (function (r, n) {
                    ...
                    !(function (e, t) {
                      ...
                      if (
                        ...
                        (o ||
                          ...
                          !n.bufferedRequest ||
                          R(e, n),
                          i ? r.nextTick(I, e, n, o, s) : I(e, n, o, s));
                      }
                    })(n, e);
                  }),
                  (this.writecb = null),
                ...
                if (e._writev && r && r.next) {
                  ...
                  for (; r; ) {
                    var u = r.chunk,
                      ...
                      h = r.callback;
                    if (
                      (T(e, t, !1, t.objectMode ? 1 : u.length, u, c, h),
                      (r = r.next),
              ...
              (e("inherits")(k, a),
                ...
                (k.prototype.write = function (e, t, n) {
                  var i,
                    ...
                    a =
                      !s.objectMode &&
                      ((i = e), l.isBuffer(i) || i instanceof u);
                  return (
                    a &&
                      !l.isBuffer(e) &&
                      (e = (function (e) {
            ...
            (function () {
              ...
              function p(e) {
                ...
                if (null !== t) {
                  var r = e[f].read();
                  null !== r &&
                    ((e[c] = null), (e[o] = null), (e[a] = null), t(d(r, !1)));
                }
              }
              function b(e) {
                r.nextTick(p, e);
                ...
                return (
                  ...
                  s(e, function (e) {
                    if (e && "ERR_STREAM_PREMATURE_CLOSE" !== e.code) {
                      ...
                      return (
                        null !== t &&
                          ((r[c] = null), (r[o] = null), (r[a] = null), t(e)),
                        void (r[l] = e)
                      );
                    }
                    var n = r[o];
          ...
          t.exports = function () {
            ...
            var f = r.map(function (t, i) {
              ...
              return (function (t, r, i, s) {
                ...
                (c || (c = e), e && f.forEach(l), s || (f.forEach(l), h(c)));
              });
            });
            return r.reduce(u);
          };
        },
        { "../../../errors": 33, "./end-of-stream": 42 }
      ],
      45: [
        function (e, t, r) {
          "use strict";
      ...
      47: [
        ...
        {
          "./lib/_stream_duplex.js": 34,
          "./lib/_stream_passthrough.js": 35,
          "./lib/_stream_readable.js": 36,
          "./lib/_stream_transform.js": 37,
          "./lib/_stream_writable.js": 38,
          "./lib/internal/streams/end-of-stream.js": 42,
          "./lib/internal/streams/pipeline.js": 44
        }
      ],
      48: [
        function (e, t, r) {
              ...
              var n = e("once"),
                ...
                s = function (e, t, o) {
                  ...
                  var a = e._writableState,
                    ...
                    y = function () {
                      if (!h)
                        return (!u || (l && l.ended && !l.destroyed)) &&
      ...
      52: [
        function (e, t, r) {
          "use strict";
          (Object.defineProperty(r, "t", { value: !0 }),
            (r.ContainerIterator = r.Container = r.Base = void 0));
      ...
      53: [
        function (e, t, r) {
          "use strict";
          (Object.defineProperty(r, "t", { value: !0 }),
            (r.HashContainerIterator = r.HashContainer = void 0));
          var n,
            i = e("../../ContainerBase"),
            s =
              (n = e("../../../utils/checkObject")) && n.t ? n : { default: n },
            o = e("../../../utils/throwError");
          ...
          class l extends i.Container {
            ...
            M(e, t, r) {
              let n;
              if ((void 0 === r && (r = (0, s.default)(e)), r)) {
                const r = e[this.HASH_TAG];
                if (void 0 !== r) return ((this.H[r].l = t), this.i);
                (Object.defineProperty(e, this.HASH_TAG, {
                  value: this.H.length,
                  configurable: !0
                }),
                  (n = { u: e, l: t, L: this._, B: this.h }),
                  this.H.push(n));
              } else {
                const r = this.g[e];
              ...
              return (
                0 === this.i ? ((this.p = n), (this.h.B = n)) : (this._.B = n),
                (this._ = n),
                (this.h.L = n),
                ++this.i
              );
            ...
            I(e, t) {
              if ((void 0 === t && (t = (0, s.default)(e)), t)) {
                const t = e[this.HASH_TAG];
                return void 0 === t ? this.h : this.H[t];
              }
              return this.g[e] || this.h;
            }
            clear() {
              const e = this.HASH_TAG;
            ...
            eraseElementByIterator(e) {
              const t = e.o;
              return (
                t === this.h && (0, o.throwIteratorAccessError)(),
                this.V(t),
                e.next()
              );
            }
      ...
      54: [
        function (e, t, r) {
          "use strict";
          (Object.defineProperty(r, "t", { value: !0 }), (r.default = void 0));
          var n,
            i = e("./Base"),
            s = (n = e("../../utils/checkObject")) && n.t ? n : { default: n },
            o = e("../../utils/throwError");
      ...
      59: [
            ...
            constructor(e, t) {
              (super(t),
                ...
                0 === this.iteratorType
                  ? ((this.pre = function () {
                      return (
                        0 === this.o && (0, i.throwIteratorAccessError)(),
                        (this.o -= 1),
                        this
                      );
                    }),
                  ...
                  : ((this.pre = function () {
                    ...
                    (this.next = function () {
                      return (
                        -1 === this.o && (0, i.throwIteratorAccessError)(),
                        (this.o -= 1),
                        this
                      );
                    })));
        ...
        { "../../../utils/throwError": 71, "../../ContainerBase": 52 }
      ],
      60: [
        function (e, t, r) {
          "use strict";
      ...
      61: [
        function (e, t, r) {
          ...
          (Object.defineProperty(r, "t", { value: !0 }), (r.default = void 0));
          var n,
            i = (n = e("./Base")) && n.t ? n : { default: n },
            s = e("./Base/RandomIterator");
          ...
          class a extends i.default {
            ...
            getElementByPos(e) {
              if (e < 0 || e > this.i - 1) throw new RangeError();
              const { curNodeBucketIndex: t, curNodePointerIndex: r } =
                this.O(e);
              return this.A[t][r];
            }
            setElementByPos(e, t) {
              if (e < 0 || e > this.i - 1) throw new RangeError();
              const { curNodeBucketIndex: r, curNodePointerIndex: n } =
                this.O(e);
              this.A[r][n] = t;
            }
            insert(e, t, r = 1) {
              ...
              if (0 === e) for (; r--; ) this.pushFront(t);
                ...
                const n = [];
                for (let t = e; t < this.i; ++t)
                  n.push(this.getElementByPos(t));
                this.cut(e - 1);
            ...
            eraseElementByValue(e) {
              ...
              for (let r = 0; r < this.i; ++r) {
                const n = this.getElementByPos(r);
                n !== e && t.push(n);
              }
              const r = t.length;
            ...
            find(e) {
              for (let t = 0; t < this.i; ++t)
                if (this.getElementByPos(t) === e) return new o(t, this);
              return this.end();
            }
            reverse() {
              let e = 0,
                t = this.i - 1;
              for (; e < t; ) {
                const r = this.getElementByPos(e);
        ...
        { "./Base": 60, "./Base/RandomIterator": 59 }
      ],
      62: [
        function (e, t, r) {
          "use strict";
          ...
          class l extends i.default {
            ...
            find(e) {
              let t = this.p;
              for (; t !== this.h; ) {
                if (t.l === e) return new a(t, this.h, this);
                t = t.B;
              }
              return this.end();
            }
        ...
        { "../../utils/throwError": 71, "../ContainerBase": 52, "./Base": 60 }
      ],
      63: [
        function (e, t, r) {
          "use strict";
          ...
          class a extends i.default {
            ...
            find(e) {
              for (let t = 0; t < this.i; ++t)
                if (this.J[t] === e) return new o(t, this);
              return this.end();
            }
            reverse() {
              this.J.reverse();
      ...
      65: [
        function (e, t, r) {
          "use strict";
          (Object.defineProperty(r, "t", { value: !0 }),
            (r.TreeNodeEnableIndex = r.TreeNode = void 0));
          class n {
            constructor(e, t) {
              ((this.ee = 1),
                (this.u = void 0),
          ...
          class o extends i.Container {
            constructor(
              ...
              (super(),
                ...
                (this.v = e),
                t
                  ? ((this.re = n.TreeNodeEnableIndex),
                    (this.M = function (e, t, r) {
                      const n = this.ne(e, t, r);
                      if (n) {
                        let e = n.tt;
            ...
            Z(e, t) {
              let r = this.h;
              for (; e; ) {
                this.v(e.u, t) <= 0 ? (e = e.W) : ((r = e), (e = e.U));
              }
              return r;
            }
            $(e, t) {
            ...
            rr(e, t) {
              let r = this.h;
              for (; e; ) {
                this.v(e.u, t) < 0 ? ((r = e), (e = e.W)) : (e = e.U);
              }
              return r;
            }
            ue(e) {
            ...
            oe(e, t) {
              ...
              return !!this.oe(e.U, t) || !!t(e) || this.oe(e.W, t);
            }
            he(e) {
              for (;;) {
                const t = e.tt;
            ...
            updateKeyByIterator(e, t) {
              const r = e.o;
              if (
                (r === this.h && (0, s.throwIteratorAccessError)(),
                1 === this.i)
              )
                return ((r.u = t), !0);
              if (r === this.h.U)
            ...
            eraseElementByIterator(e) {
              const t = e.o;
              t === this.h && (0, s.throwIteratorAccessError)();
              const r = void 0 === t.W;
              return (
                0 === e.iteratorType
                  ? r && e.next()
      ...
      68: [
        function (e, t, r) {
          ...
          class l extends n.default {
            ...
            *K(e) {
              void 0 !== e &&
                (yield* this.K(e.U), yield e.u, yield* this.K(e.W));
            }
            begin() {
              return new a(this.h.U || this.h, this.h, this);
            }
      ...
      69: [
        function (e, t, r) {
          ...
          var n = d(e("./container/OtherContainer/Stack")),
            i = d(e("./container/OtherContainer/Queue")),
            s = d(e("./container/OtherContainer/PriorityQueue")),
            o = d(e("./container/SequentialContainer/Vector")),
            a = d(e("./container/SequentialContainer/LinkList")),
            l = d(e("./container/SequentialContainer/Deque")),
            u = d(e("./container/TreeContainer/OrderedSet")),
            c = d(e("./container/TreeContainer/OrderedMap")),
            h = d(e("./container/HashContainer/HashSet")),
            f = d(e("./container/HashContainer/HashMap"));
          function d(e) {
            return e && e.t ? e : { default: e };
          }
        },
        {
          "./container/HashContainer/HashMap": 54,
          "./container/HashContainer/HashSet": 55,
          "./container/OtherContainer/PriorityQueue": 56,
          "./container/OtherContainer/Queue": 57,
          "./container/OtherContainer/Stack": 58,
          "./container/SequentialContainer/Deque": 61,
          "./container/SequentialContainer/LinkList": 62,
          "./container/SequentialContainer/Vector": 63,
          "./container/TreeContainer/OrderedMap": 67,
          "./container/TreeContainer/OrderedSet": 68
        }
      ],
      70: [
        function (e, t, r) {
      ...
      71: [
        function (e, t, r) {
          "use strict";
          (Object.defineProperty(r, "t", { value: !0 }),
            (r.throwIteratorAccessError = function () {
          ...
          (function (e) {
            (function () {
              const r =
                ...
                i = "function" == typeof AbortSignal,
                s = "function" == typeof n.AbortSignal,
                o = i
                  ? AbortSignal
                  : s
                    ? n.AbortController
                ...
                l = (e, t) => {
                  ...
                  h(r) && f(r, `${e} option`, `options.${t}`, m);
                },
                u = (e, t) => {
                  const r = `LRU_CACHE_METHOD_${e}`;
                  if (h(r)) {
                    const { prototype: n } = m,
                      { get: i } = Object.getOwnPropertyDescriptor(n, e);
                    f(r, `${e} method`, `cache.${t}()`, i);
                  }
                },
                c = (...t) => {
                  "object" == typeof e &&
              ...
              class m {
                constructor(e = {}) {
                  ...
                  const M = t ? p(t) : Array;
                  if (!M) throw new Error("invalid max value: " + t);
                  if (
                    ((this.max = t),
                    (this.maxSize = w),
                    (this.maxEntrySize = v || this.maxSize),
                    (this.sizeCalculation = S || C),
                  ...
                  if (
                    ((this.fetchContext = A), !this.fetchMethod && void 0 !== A)
                  )
                    throw new TypeError(
                  ...
                  if (
                    ...
                    "function" == typeof b
                      ? ((this.disposeAfter = b), (this.disposed = []))
                      : ((this.disposeAfter = null), (this.disposed = null)),
                    (this.noDisposeOnSet = !!y),
                    (this.noUpdateTTL = !!_),
                    (this.noDeleteOnFetchRejection = !!k),
                    (this.allowStaleOnFetchRejection = !!I),
                  ...
                  if (
                    ...
                    (this.ttlResolution = d(n) || 0 === n ? n : 1),
                    (this.ttlAutopurge = !!i),
                    (this.ttl = r || P || 0),
                    this.ttl)
                  ) {
                  ...
                  (x && l("stale", "allowStale"),
                    P && l("maxAge", "ttl"),
                    C && l("length", "sizeCalculation"));
                }
                getRemainingTTL(e) {
                  return this.has(e, { updateAgeOnHas: !1 }) ? 1 / 0 : 0;
                }
                initializeTTLTracking() {
                  ((this.ttls = new b(this.max)),
                    (this.starts = new b(this.max)),
                    (this.setItemTTL = (e, t, n = r.now()) => {
                      if (
                    ...
                    (this.updateItemAge = e => {
                      this.starts[e] = 0 !== this.ttls[e] ? r.now() : 0;
                    }),
                    (this.statusTTL = (r, n) => {
                      r &&
                        ((r.ttl = this.ttls[n]),
                        (r.start = this.starts[n]),
                        (r.now = e || t()),
                        (r.remainingTTL = r.now + r.ttl - r.start));
                    }));
                  let e = 0;
                  const t = () => {
                    const t = r.now();
                    if (this.ttlResolution > 0) {
                      e = t;
                      const r = setTimeout(() => (e = 0), this.ttlResolution);
                      r.unref && r.unref();
                    }
                    return t;
                  };
                  ((this.getRemainingTTL = r => {
                    ...
                    return void 0 === n
                      ...
                      : 0 === this.ttls[n] || 0 === this.starts[n]
                        ? 1 / 0
                        : this.starts[n] + this.ttls[n] - (e || t());
                  }),
                    (this.isStale = r =>
                      0 !== this.ttls[r] &&
                      0 !== this.starts[r] &&
                      (e || t()) - this.starts[r] > this.ttls[r]));
                }
                updateItemAge(e) {}
                statusTTL(e, t) {}
                setItemTTL(e, t, r) {}
                  ...
                  ((this.calculatedSize = 0),
                    ...
                    (this.addItemSize = (e, t, r) => {
                      ...
                      ((this.calculatedSize += this.sizes[e]),
                        r &&
                          ((r.entrySize = t),
                          (r.totalCalculatedSize = this.calculatedSize)));
                    }));
                }
                removeItemSize(e) {}
                addItemSize(e, t) {}
                ...
                *rvalues() {
                ...
                find(e, t) {
                  for (const r of this.indexes()) {
                    const n = this.valList[r],
                      i = this.isBackgroundFetch(n)
                        ? n.__staleWhileFetching
                        : n;
                    if (void 0 !== i && e(i, this.keyList[r], this))
                  ...
                  for (const r of this.indexes()) {
                    const n = this.valList[r],
                      i = this.isBackgroundFetch(n)
                        ? n.__staleWhileFetching
                        : n;
                    void 0 !== i && e.call(t, i, this.keyList[r], this);
                  }
                }
                rforEach(e, t = this) {
                ...
                dump() {
                  ...
                  for (const t of this.indexes({ allowStale: !0 })) {
                    ...
                    if (this.ttls) {
                      o.ttl = this.ttls[t];
                      const e = r.now() - this.starts[t];
                      o.start = Math.floor(Date.now() - e);
                    }
                    (this.sizes && (o.size = this.sizes[t]), e.unshift([n, o]));
                  }
                  return e;
                }
                load(e) {
                ...
                set(
                  ...
                  if (
                    ((s = this.requireSize(e, t, s, o)),
                    this.maxEntrySize && s > this.maxEntrySize)
                  )
                    return (
                  ...
                  let u = 0 === this.size ? void 0 : this.keyMap.get(e);
                  if (void 0 === u)
                    ((u = this.newIndex()),
                      (this.keyList[u] = e),
                      (this.valList[u] = t),
                      this.keyMap.set(e, u),
                      (this.next[this.tail] = u),
                      (this.prev[u] = this.tail),
                      (this.tail = u),
                      this.size++,
                      this.addItemSize(u, s, l),
                      l && (l.set = "add"),
                      (a = !1));
                  else {
                    this.moveToTail(u);
                    const r = this.valList[u];
                    if (t !== r) {
                      if (
                ...
                has(
                  e,
                  { updateAgeOnHas: t = this.updateAgeOnHas, status: r } = {}
                ) {
                  const n = this.keyMap.get(e);
                  if (void 0 !== n) {
                    if (!this.isStale(n))
                      return (
                        t && this.updateItemAge(n),
                        r && (r.has = "hit"),
                        this.statusTTL(r, n),
                        !0
                      );
                ...
                peek(e, { allowStale: t = this.allowStale } = {}) {
                  ...
                  if (void 0 !== r && (t || !this.isStale(r))) {
                    const e = this.valList[r];
                    return this.isBackgroundFetch(e)
                      ? e.__staleWhileFetching
                      : e;
                  }
                }
                backgroundFetch(e, t, r, i) {
                  const s = void 0 === t ? void 0 : this.valList[t];
                  if (this.isBackgroundFetch(s)) return s;
                  const o = new n();
                  r.signal &&
                    r.signal.addEventListener("abort", () =>
                      o.abort(r.signal.reason)
                    );
                  const a = { signal: o.signal, options: r, context: i },
                    l = (n, i = !1) => {
                      const { aborted: s } = o.signal,
                        l = r.ignoreFetchAbort && void 0 !== n;
                      return (
                        r.status &&
                          (s && !i
                            ? ((r.status.fetchAborted = !0),
                              (r.status.fetchError = o.signal.reason),
                  ...
                  const c = new Promise((t, n) => {
                    (this.fetchMethod(e, s, a).then(e => t(e), n),
                  ...
                  return (
                    (c.__abortController = o),
                    (c.__staleWhileFetching = s),
                    (c.__returned = null),
                    void 0 === t
                      ? (this.set(e, c, { ...a.options, status: void 0 }),
                        (t = this.keyMap.get(e)))
                      : (this.valList[t] = c),
                    c
                  );
                ...
                async fetch(
                  ...
                  if (void 0 === y) {
                    b && (b.fetch = "miss");
                    const t = this.backgroundFetch(e, y, m, d);
                    return (t.__returned = t);
                  }
                  {
                    const n = this.valList[y];
                    if (this.isBackgroundFetch(n)) {
                      const e = t && void 0 !== n.__staleWhileFetching;
                      return (
                        b &&
                          ((b.fetch = "inflight"), e && (b.returnedStale = !0)),
                        e ? n.__staleWhileFetching : (n.__returned = n)
                      );
                    }
                    const i = this.isStale(y);
                    if (!p && !i)
                      return (
                        b && (b.fetch = "hit"),
                        this.moveToTail(y),
                        r && this.updateItemAge(y),
                        this.statusTTL(b, y),
                        n
                      );
                    const s = this.backgroundFetch(e, y, m, d),
                      o = void 0 !== s.__staleWhileFetching,
                      a = o && t;
                    return (
                      b &&
                        ((b.fetch = o && i ? "stale" : "refresh"),
                        a && i && (b.returnedStale = !0)),
                ...
                get(
                  ...
                  if (void 0 !== s) {
                    const o = this.valList[s],
                      a = this.isBackgroundFetch(o);
                    return (
                      this.statusTTL(i, s),
                      this.isStale(s)
                        ? (i && (i.get = "stale"),
                          a
                            ? (i &&
                                (i.returnedStale =
                                  t && void 0 !== o.__staleWhileFetching),
      ...
      73: [
        function (e, t, r) {
          ...
          for (const e in n.requiredHeaderFlags) {
            const t = n.requiredHeaderFlags[e];
            n.requiredHeaderFlagsErrors[e] =
      ...
      74: [
        function (e, t, r) {
          ...
          class o extends i {
            ...
            concat() {
              ...
              let n,
                i = 0;
              for (n = 0; n < r.length && void 0 !== r[n]; n++)
                ("string" != typeof r[n]
                  ? (t[n] = r[n].length)
                  : (t[n] = s.byteLength(r[n])),
                  (e += t[n]));
        ...
        { "./writeToStream": 96, buffer: 29, events: 49 }
      ],
      75: [
        function (e, t, r) {
        ...
        { "./generate": 74, "./parser": 95, "./writeToStream": 96 }
      ],
      76: [
        function (e, t, r) {
          "use strict";
            ...
            (s.prototype.copy = function (e, t, r, i) {
              ...
              if (0 === r && i === this.length) {
                ...
                for (let t = 0; t < this._bufs.length; t++)
                  (this._bufs[t].copy(e, u), (u += this._bufs[t].length));
                return e;
              }
              if (l <= this._bufs[o[0]].length - c)
                return s
                  ? this._bufs[o[0]].copy(e, t, c, c + l)
                  : this._bufs[o[0]].slice(c, c + l);
              s || (e = n.allocUnsafe(a));
      ...
      77: [
        function (e, t, r) {
          ...
          function o(e) {
            ...
            (s._init.call(this, e), n.call(this));
          }
          (i(o, n),
            Object.assign(o.prototype, s.prototype),
            ...
            (o.prototype._isBufferList = function (e) {
              return e instanceof o || e instanceof s || o.isBufferList(e);
            }),
            (o.isBufferList = s.isBufferList),
            (t.exports = o),
            (t.exports.BufferListStream = o),
            (t.exports.BufferList = s));
        },
        { "./BufferList": 76, inherits: 51, "readable-stream": 92 }
      ],
      78: [
        function (e, t, r) {
      ...
      80: [
        ...
        { "./_stream_transform": 82, dup: 35, inherits: 51 }
      ],
      81: [
        function (e, t, r) {
        ...
        },
        {
          "../errors": 78,
          "./_stream_duplex": 79,
          "./internal/streams/async_iterator": 84,
          "./internal/streams/buffer_list": 85,
          "./internal/streams/destroy": 86,
          "./internal/streams/from": 88,
          "./internal/streams/state": 90,
          "./internal/streams/stream": 91,
          _process: 102,
          buffer: 29,
          dup: 36,
          events: 49,
      ...
      82: [
        ...
        { "../errors": 78, "./_stream_duplex": 79, dup: 37, inherits: 51 }
      ],
      83: [
        function (e, t, r) {
      ...
      84: [
        ...
        { "./end-of-stream": 87, _process: 102, dup: 39 }
      ],
      85: [
        function (e, t, r) {
          arguments[4][40][0].apply(r, arguments);
        },
        { buffer: 29, dup: 40, util: 26 }
      ],
      86: [
        function (e, t, r) {
      ...
      89: [
        ...
        { "../../../errors": 78, "./end-of-stream": 87, dup: 44 }
      ],
      90: [
        function (e, t, r) {
      ...
      92: [
        ...
        {
          "./lib/_stream_duplex.js": 79,
          "./lib/_stream_passthrough.js": 80,
          "./lib/_stream_readable.js": 81,
          "./lib/_stream_transform.js": 82,
          "./lib/_stream_writable.js": 83,
          "./lib/internal/streams/end-of-stream.js": 87,
          "./lib/internal/streams/pipeline.js": 89,
          dup: 47
        }
      ],
      93: [
        function (e, t, r) {
          const { Buffer: n } = e("buffer"),
            i = {},
            s = n.isBuffer(n.from([1, 2]).subarray(0, 1));
          function o(e) {
          ...
          t.exports = {
            ...
            generateCache: function () {
              for (let e = 0; e < 65536; e++) i[e] = o(e);
            },
            generateNumber: o,
            genBufVariableByteInt: function (e) {
              let t = 0,
                r = 0;
              const i = n.allocUnsafe(4);
              do {
                ((t = e % 128 | 0),
                  (e = (e / 128) | 0) > 0 && (t |= 128),
                  i.writeUInt8(t, r++));
              } while (e > 0 && r < 4);
              return (e > 0 && (r = 0), s ? i.subarray(0, r) : i.slice(0, r));
            },
        ...
        function (e, t, r) {
          ...
          class l extends i {
            ...
            _parseConnect() {
              ...
              if (((s.protocolId = l), this._pos >= this._list.length))
              ...
              ((i.username = this._list.readUInt8(this._pos) & o.USERNAME_MASK),
                (i.password =
                  this._list.readUInt8(this._pos) & o.PASSWORD_MASK),
                (i.will = this._list.readUInt8(this._pos) & o.WILL_FLAG_MASK));
              const u = !!(
                  this._list.readUInt8(this._pos) & o.WILL_RETAIN_MASK
                ),
                c =
              ...
              if (
                ((s.clean =
                  0 !=
                  (this._list.readUInt8(this._pos) & o.CLEAN_SESSION_MASK)),
                this._pos++,
              ...
              if (
                ((s.clientId = h),
                a("_parseConnect: packet.clientId: %s", s.clientId),
                i.will)
              ) {
                if (5 === s.protocolVersion) {
                  const e = this._parseProperties();
                ...
                if (
                  ((s.will.topic = e),
                  a("_parseConnect: packet.will.topic: %s", s.will.topic),
                  (t = this._parseBuffer()),
                  null === t)
                )
                  return this._emitError(
                ...
                ((s.will.payload = t),
                  a("_parseConnect: packet.will.paylaod: %s", s.will.payload));
              }
              if (i.username) {
                if (((n = this._parseString()), null === n))
                  return this._emitError(new Error("Cannot parse username"));
                ((s.username = n),
                  a("_parseConnect: packet.username: %s", s.username));
              }
              if (i.password) {
              ...
              return ((this.settings = s), a("_parseConnect: complete"), s);
            }
            _parseConnack() {
              a("_parseConnack");
              const e = this.packet;
              if (this._list.length < 1) return null;
              const t = this._list.readUInt8(this._pos++);
              if (t > 1)
                return this._emitError(
            ...
            _parsePublish() {
              ...
              if (!(e.qos > 0) || this._parseMessageId()) {
                ...
                ((e.payload = this._list.slice(this._pos, e.length)),
                  a("_parsePublish: payload from buffer list: %o", e.payload));
              }
            }
            _parseSubscribe() {
              a("_parseSubscribe");
              ...
              if (((e.subscriptions = []), this._parseMessageId())) {
                ...
                for (; this._pos < e.length; ) {
                  ...
                  if (((n = r & o.SUBSCRIBE_OPTIONS_QOS_MASK), n > 2))
                    return this._emitError(
                  ...
                  if (
                    ((l =
                      0 !=
                      ((r >> o.SUBSCRIBE_OPTIONS_NL_SHIFT) &
                        o.SUBSCRIBE_OPTIONS_NL_MASK)),
                    (s =
                      0 !=
                      ((r >> o.SUBSCRIBE_OPTIONS_RAP_SHIFT) &
                        o.SUBSCRIBE_OPTIONS_RAP_MASK)),
                    (i =
                      (r >> o.SUBSCRIBE_OPTIONS_RH_SHIFT) &
            ...
            _parseConfirmation() {
              ...
              const e = this.packet;
              if (
                (this._parseMessageId(), 5 === this.settings.protocolVersion)
              ) {
                if (e.length > 2) {
                  switch (
                    ((e.reasonCode = this._parseByte()), this.packet.cmd)
                  ) {
                    case "puback":
                    case "pubrec":
                  ...
                  a("_parseConfirmation: packet.reasonCode `%d`", e.reasonCode);
                } else e.reasonCode = 0;
                if (e.length > 3) {
                  const t = this._parseProperties();
                  Object.getOwnPropertyNames(t).length && (e.properties = t);
            ...
            _parseDisconnect() {
              const e = this.packet;
              if (
                (a("_parseDisconnect"), 5 === this.settings.protocolVersion)
              ) {
                this._list.length > 0
                  ? ((e.reasonCode = this._parseByte()),
                    o.MQTT5_DISCONNECT_CODES[e.reasonCode] ||
                      this._emitError(
                        new Error("Invalid disconnect reason code")
                      ))
                  : (e.reasonCode = 0);
                const t = this._parseProperties();
                Object.getOwnPropertyNames(t).length && (e.properties = t);
            ...
            _parseMessageId() {
              ...
              return (
                ...
                null === e.messageId
                  ...
                  : (a("_parseMessageId: packet.messageId %d", e.messageId), !0)
              );
            }
            _parseString(e) {
            ...
            _parseVarByteNum(e) {
              ...
              return (
                ...
                l && (this._pos += r),
                (s = !!s && (e ? { bytes: r, value: i } : i)),
                a("_parseVarByteNum: result: %o", s),
                s
              );
            }
            _parseByte() {
            ...
            _parseProperties() {
              ...
              for (; this._pos < t; ) {
                ...
                if ("userProperties" !== t)
                  ...
                  const e = this._parseByType(o.propertiesTypes[t]);
                  if (r[t][e.name])
            ...
            _emitError(e) {
              (a("_emitError", e), (this.error = e), this.emit("error", e));
            }
          }
          t.exports = l;
        },
        { "./constants": 73, "./packet": 94, bl: 77, debug: 30, events: 49 }
      ],
      96: [
        function (e, t, r) {
          const n = e("./constants"),
            ...
            o = i.from([0]),
            a = e("./numbers"),
            l = e("process-nextick-args").nextTick,
            u = e("debug")("mqtt-packet:writeToStream"),
            c = a.cache,
            h = a.generateNumber,
            f = a.generateCache,
            d = a.genBufVariableByteInt,
            ...
            switch (
              ...
              case "connect":
                return (function (e, t, r) {
                  const s = e || {},
                    o = s.protocolId || "MQTT";
                  let a = s.protocolVersion || 4;
                  const l = s.will;
                  let u = s.clean;
                  const c = s.keepalive || 0,
                    h = s.clientId || "",
                    f = s.username,
                    d = s.password,
                    p = s.properties;
                  ...
                  let g,
                    m,
                    y = 0;
                  if (!o || ("string" != typeof o && !i.isBuffer(o)))
                    return (t.destroy(new Error("Invalid protocolId")), !1);
                  y += o.length + 2;
                  if (3 !== a && 4 !== a && 5 !== a)
                    return (
                      t.destroy(new Error("Invalid protocol version")),
                      !1
                    );
                  y += 1;
                  if (
                    ("string" == typeof h || i.isBuffer(h)) &&
                    (h || a >= 4) &&
                    (h || u)
                  )
                    y += i.byteLength(h) + 2;
                  ...
                  if (l) {
                    ...
                    if (
                      ((y += i.byteLength(l.topic) + 2), (y += 2), l.payload)
                    ) {
                      if (!(l.payload.length >= 0))
                        return (
                          t.destroy(new Error("Invalid will payload")),
                          !1
                        );
                      "string" == typeof l.payload
                        ? (y += i.byteLength(l.payload))
                        : (y += l.payload.length);
                    }
                    if (((m = {}), 5 === a)) {
                      if (((m = T(t, l.properties)), !m)) return !1;
                      y += m.length;
                    }
                  }
                  let _ = !1;
                  if (null != f) {
                    if (!P(f))
                      return (t.destroy(new Error("Invalid username")), !1);
                    ((_ = !0), (y += i.byteLength(f) + 2));
                  }
                  if (null != d) {
                    if (!_)
                      return (
                    ...
                    if (!P(d))
                      return (t.destroy(new Error("Invalid password")), !1);
                    y += C(d) + 2;
                  }
                  ...
                  let S = 0;
                  ((S |= null != f ? n.USERNAME_MASK : 0),
                    (S |= null != d ? n.PASSWORD_MASK : 0),
                    (S |= l && l.retain ? n.WILL_RETAIN_MASK : 0),
                    (S |= l && l.qos ? l.qos << n.WILL_QOS_SHIFT : 0),
                    (S |= l ? n.WILL_FLAG_MASK : 0),
                  ...
                  (k(t, h),
                    l &&
                      (5 === a && m.write(), v(t, l.topic), k(t, l.payload)));
                  null != f && k(t, f);
                  null != d && k(t, d);
                  return !0;
                })(e, t);
              case "connack":
                return (function (e, t, r) {
                  ...
                  let h = null;
                  if (5 === s) {
                    if (((h = T(t, u)), !h)) return !1;
                    c += h.length;
                  }
                  (t.write(n.CONNACK_HEADER),
                    w(t, c),
                    t.write(a.sessionPresent ? n.SESSIONPRESENT_HEADER : o),
                    t.write(i.from([l])),
                    null != h && h.write());
                  return !0;
                })(e, t, r);
              case "publish":
                return (function (e, t, r) {
                  ...
                  const o = r ? r.protocolVersion : 4,
                    ...
                    p = a.properties;
                  let g = 0;
                  if ("string" == typeof h) g += i.byteLength(h) + 2;
                  else {
                    if (!i.isBuffer(h))
                  ...
                  if (l && "number" != typeof d)
                    return (t.destroy(new Error("Invalid messageId")), !1);
                  l && (g += 2);
                  let m = null;
                  if (5 === o) {
                    if (((m = T(t, p)), !m)) return !1;
                    g += m.length;
                  }
                  (t.write(n.PUBLISH_HEADER[l][a.dup ? 1 : 0][c ? 1 : 0]),
                    w(t, g),
                    b(t, C(h)),
                    t.write(h),
                    l > 0 && b(t, d));
                  null != m && m.write();
                  return (u("publish: payload: %o", f), t.write(f));
                })(e, t, r);
              case "puback":
              case "pubrec":
              case "pubrel":
              case "pubcomp":
                return (function (e, t, r) {
                  const s = r ? r.protocolVersion : 4,
                    ...
                    a = o.cmd || "puback",
                    l = o.messageId,
                    u = o.dup && "pubrel" === a ? n.DUP_MASK : 0;
                  let c = 0;
                  const h = o.reasonCode,
                    f = o.properties;
                  let d = 5 === s ? 3 : 2;
                  "pubrel" === a && (c = 1);
                  if ("number" != typeof l)
                  ...
                  (w(t, d),
                    b(t, l),
                    5 === s && 2 !== d && t.write(i.from([h])));
                  null !== p ? p.write() : 4 === d && t.write(i.from([0]));
                  return !0;
                })(e, t, r);
              case "subscribe":
                return (function (e, t, r) {
                  ...
                  (u("subscribe: writing to stream: %o", n.SUBSCRIBE_HEADER),
                  ...
                  for (const e of c) {
                    ...
                    let c;
                    (v(t, r),
                      (c = n.SUBSCRIBE_OPTIONS_QOS[o]),
                      5 === s &&
                        ((c |= a ? n.SUBSCRIBE_OPTIONS_NL : 0),
                        (c |= l ? n.SUBSCRIBE_OPTIONS_RAP : 0),
                        (c |= u ? n.SUBSCRIBE_OPTIONS_RH[u] : 0)),
                      (p = t.write(i.from([c]))));
                  }
                  return p;
                })(e, t, r);
              ...
              case "unsubscribe":
                return (function (e, t, r) {
                  ...
                  if ("object" != typeof u || !u.length)
                    return (
                      t.destroy(new Error("Invalid unsubscriptions")),
                      !1
                    );
                  ...
                  (t.write(n.UNSUBSCRIBE_HEADER[1][l ? 1 : 0][0]),
                    w(t, h),
                    b(t, a),
                    null !== f && f.write());
                  let d = !0;
                  for (let e = 0; e < u.length; e++) d = v(t, u[e]);
                  return d;
                })(e, t, r);
              case "unsuback":
                return (function (e, t, r) {
                  ...
                  let p = null;
                  if (5 === s) {
                    if (((p = I(t, c, r, d)), !p)) return !1;
                    d += p.length;
                  }
                  (t.write(n.ACKS[h][f][l][0]),
                    w(t, d),
                    b(t, a),
                    null !== p && p.write());
                  5 === s && t.write(i.from(u));
                  return !0;
                })(e, t, r);
              case "pingreq":
              case "pingresp":
              ...
              case "disconnect":
                return (function (e, t, r) {
                  ...
                  let u = 5 === s ? 1 : 0,
                    c = null;
                  if (5 === s) {
                    if (((c = I(t, l, r, u)), !c)) return !1;
                    u += c.length;
                  }
                  (t.write(i.from([n.codes.disconnect << 4])),
                    w(t, u),
                    5 === s && t.write(i.from([a])));
                  null !== c && c.write();
                  return !0;
                })(e, t, r);
              case "auth":
          ...
          Object.defineProperty(m, "cacheNumbers", {
            ...
            set(e) {
              e
                ? ((c && 0 !== Object.keys(c).length) || (g = !0), (b = E))
                : ((g = !1), (b = A));
            }
          });
          const _ = {};
          function w(e, t) {
            if (t > n.VARBYTEINT_MAX)
              return (
                e.destroy(new Error(`Invalid variable byte integer: ${t}`)),
                !1
              );
            let r = _[t];
            return (
              r || ((r = d(t)), t < 16384 && (_[t] = r)),
              u("writeVarByteInt: writing to stream: %o", r),
              e.write(r)
            );
          }
          function v(e, t) {
            const r = i.byteLength(t);
          ...
          function T(e, t) {
            ...
            function s(t, r) {
              ...
              switch (n.propertiesTypes[t]) {
                case "byte":
                  if ("boolean" != typeof r)
                    return (e.destroy(new Error(`Invalid ${t}: ${r}`)), !1);
                  s += 2;
                  break;
                case "int8":
                ...
                case "int32":
                  ...
                  break;
                case "var":
                  if ("number" != typeof r || r < 0 || r > 268435455)
                    return (e.destroy(new Error(`Invalid ${t}: ${r}`)), !1);
                  s += 1 + i.byteLength(d(r));
                  break;
                case "string":
                  if ("string" != typeof r)
                    return (e.destroy(new Error(`Invalid ${t}: ${r}`)), !1);
                  s += 3 + i.byteLength(r.toString());
                  break;
                case "pair":
                  if ("object" != typeof r)
                    return (e.destroy(new Error(`Invalid ${t}: ${r}`)), !1);
                  s += Object.getOwnPropertyNames(r).reduce((e, t) => {
                    const n = r[t];
                    return (
                      Array.isArray(n)
                        ? (e += n.reduce(
                ...
                default:
                  return (
                    e.destroy(new Error(`Invalid property ${t}: ${r}`)),
                    !1
                  );
              }
              return s;
          ...
          function R(e, t, r) {
            switch (n.propertiesTypes[t]) {
              ...
              case "int8":
                ...
                break;
              case "binary":
                (e.write(i.from([n.properties[t]])), k(e, r));
                break;
              case "int16":
                (e.write(i.from([n.properties[t]])), b(e, r));
                break;
              case "int32":
              ...
              case "pair":
                Object.getOwnPropertyNames(r).forEach(s => {
                  ...
                  Array.isArray(o)
                    ? o.forEach(r => {
                        (e.write(i.from([n.properties[t]])),
                          S(e, s.toString(), r.toString()));
                      })
                    : (e.write(i.from([n.properties[t]])),
                      S(e, s.toString(), o.toString()));
                });
                break;
              default:
                return (
                  e.destroy(new Error(`Invalid property ${t} value: ${r}`)),
                  !1
                );
            }
          }
      ...
      98: [
        ...
        { "./lib/number-allocator.js": 99 }
      ],
      99: [
        function (e, t, r) {
          "use strict";
          const n = e("js-sdsl").OrderedSet,
            i = e("debug")("number-allocator:trace"),
            s = e("debug")("number-allocator:error");
          function o(e, t) {
          ...
          ((o.prototype.equals = function (e) {
            ...
            (a.prototype.use = function (e) {
              ...
              if (!r.equals(this.ss.end())) {
                const n = r.pointer.low,
                  s = r.pointer.high;
                return r.pointer.equals(t)
                  ? (this.ss.eraseElementByIterator(r), i("use():" + e), !0)
                  : !(n > e) &&
                      (n === e
                        ? (this.ss.updateKeyByIterator(r, new o(n + 1, s)),
                          i("use():" + e),
                          !0)
                        : s === e
                          ? (this.ss.updateKeyByIterator(r, new o(n, s - 1)),
                            i("use():" + e),
                            !0)
                          : (this.ss.updateKeyByIterator(r, new o(e + 1, s)),
                            this.ss.insert(new o(n, e - 1)),
                            i("use():" + e),
                            !0));
              }
          ...
          ((s.nextTick = function (e) {
            ...
            if (arguments.length > 1)
              for (var r = 1; r < arguments.length; r++)
                t[r - 1] = arguments[r];
            (c.push(new b(e, t)), 1 !== c.length || h || l(p));
          }),
            ...
            (function () {
              !(function (n) {
                ...
                function P(e, t, r) {
                  var n = 0;
                  for (
                    e = r ? E(e / p) : e >> 1, e += E(e / t);
                    e > (S * f) >> 1;
                    n += c
                  )
                    e = E(e / S);
                  return E(n + ((S + 1) * e) / (e + d));
                }
                function x(e) {
                  var t,
                    r,
                    ...
                    for (
                      ...
                      i >= w && k("invalid-input"),
                        ((l =
                          ...
                          k("overflow"),
                        (v += l * o),
                        !(l < (d = a <= A ? h : a >= A + f ? f : a - A));
                      a += c
                    )
                      (o > E(u / (p = c - d)) && k("overflow"), (o *= p));
                    ((A = P(v - s, (t = _.length + 1), 0 == s)),
                      E(v / t) > u - S && k("overflow"),
                      (S += E(v / t)),
                      (v %= t),
                      _.splice(v++, 0, S));
                  }
                ...
                function M(e) {
                  var t,
                    ...
                    T = [];
                  for (
                    _ = (e = R(e)).length, t = g, r = 0, s = b, o = 0;
                    o < _;
                    ++o
                  )
                    (y = e[o]) < 128 && T.push(A(y));
                  for (n = i = T.length, i && T.push(m); n < _; ) {
                    for (a = u, o = 0; o < _; ++o)
                      (y = e[o]) >= t && y < a && (a = y);
                    for (
                      a - t > E((u - r) / (w = n + 1)) && k("overflow"),
                        r += (a - t) * w,
                        t = a,
                        o = 0;
                      o < _;
                      ...
                      if (
                        ((y = e[o]) < t && ++r > u && k("overflow"), y == t)
                      ) {
                        for (
                          l = r, d = c;
                          !(l < (p = d <= s ? h : d >= s + f ? f : d - s));
                          d += c
                        )
                          ((S = l - p),
                            (v = c - p),
                ...
                if (
                  ((a = {
                    ...
                    toUnicode: function (e) {
                      return I(e, function (e) {
                        return y.test(e) ? x(e.slice(4).toLowerCase()) : e;
                      });
                    }
                  }),
                  i && s)
                )
                  if (t.exports == i) s.exports = a;
      ...
      107: [
          ...
          ((t.exports.addAbortSignal = function (e, r) {
            ...
            (t.exports.addAbortSignalNoValidate = function (e, t) {
              ...
              const r = s(t)
                ...
                : () => {
                    t[a](new n(void 0, { cause: e.reason }));
                  };
              return (
                e.aborted
                  ? r()
        ...
        { "../../ours/errors": 126, "./end-of-stream": 113, "./utils": 122 }
      ],
      108: [
        function (e, t, r) {
          "use strict";
          ...
          t.exports = class {
            ...
            concat(e) {
              ...
              let r = this.head,
                n = 0;
              for (; r; ) (s(t, r.data, n), (n += r.data.length), (r = r.next));
              return t;
            }
            consume(e, t) {
                  ...
                  e === s.length
                    ? ((t += s),
                      ...
                      r.next
                        ? (this.head = r.next)
                        : (this.head = this.tail = null))
                    : ((t += n(s, 0, e)), (this.head = r), (r.data = n(s, e)));
                  break;
                }
                ((t += s), (e -= s.length), ++i);
              } while (null !== (r = r.next));
                  ...
                  e === a.length
                    ? (s(t, a, r - e),
                      ...
                      n.next
                        ? (this.head = n.next)
                        : (this.head = this.tail = null))
                    : (s(t, new o(a.buffer, a.byteOffset, e), r - e),
                      (this.head = n),
                      (n.data = a.slice(e)));
                  break;
                }
                (s(t, a, r - e), (e -= a.length), ++i);
              } while (null !== (n = n.next));
              return ((this.length -= i), t);
            }
            [Symbol.for("nodejs.util.inspect.custom")](e, t) {
              return l(this, { ...t, depth: 0, customInspect: !1 });
            }
          };
        },
        { "../../ours/primordials": 127, "../../ours/util": 128, buffer: 29 }
      ],
      109: [
        function (e, t, r) {
          "use strict";
          ...
          t.exports = function (...e) {
            ...
            const t = [...e];
            if (
              ("function" == typeof e[0] && (e[0] = i.from(e[0])),
              "function" == typeof e[e.length - 1])
            ) {
              const t = e.length - 1;
              e[t] = i.from(e[t]);
            ...
            const v = e[0],
              S = n(e, function (e) {
                const t = _;
                ((_ = null),
                  t ? t(e) : e ? w.destroy(e) : A || E || w.destroy());
              }),
              E = !!(l(v) || h(v) || c(v)),
              A = !!(a(S) || f(S) || c(S));
            if (
              ((w = new i({
                ...
                readableObjectMode: !(null == S || !S.writableObjectMode),
                writable: E,
                readable: A
              })),
              E)
              ...
              if (o(v))
                ...
                const e = (c(v) ? v.writable : v).getWriter();
                ((w._write = async function (t, r, n) {
                  ...
                  (w._final = async function (t) {
                    try {
                      (await e.ready, e.close().catch(() => {}), (m = t));
                    } catch (e) {
                      t(e);
                    }
                  }));
              ...
              if (o(S))
                (S.on("readable", function () {
                  ...
                  (w._read = function () {
                    for (;;) {
                      const e = S.read();
                      if (null === e) return void (y = w._read);
                      if (!w.push(e)) return;
                    }
                  }));
              else if (u(S)) {
        ...
        function (e, t, r) {
          ...
          function b(e, t, r) {
            ...
            function s(t) {
              ...
              (p(t, o, s),
                ...
                t ? n.nextTick(g, e, t) : n.nextTick(m, e));
            }
            try {
              e._destroy(t || null, s);
            } catch (t) {
          ...
          function _(e, t, r) {
            const i = e._readableState,
              s = e._writableState;
            if ((null != s && s.destroyed) || (null != i && i.destroyed))
              return this;
            (null != i && i.autoDestroy) || (null != s && s.autoDestroy)
              ? e.destroy(t)
              : t &&
                (t.stack,
          ...
          function w(e) {
            let t = !1;
            function r(r) {
              if (t) return void _(e, null != r ? r : new s());
              t = !0;
              const i = e._readableState,
                o = e._writableState,
                a = o || i;
          ...
          t.exports = {
            construct: function (e, t) {
              ...
              (r && (r.constructed = !1),
                i && (i.constructed = !1),
                e.once(d, t),
                e.listenerCount(d) > 1 || n.nextTick(w, e));
            },
      ...
      111: [
        function (e, t, r) {
          ...
          (n(u.prototype, {
            ...
            (u.from = function (t) {
              return (h || (h = e("./duplexify")), h(t, "body"));
            }));
        },
        {
          "../../ours/primordials": 127,
      ...
      112: [
        function (e, t, r) {
          const n = e("process/"),
            ...
            {
              AbortError: d,
              codes: { ERR_INVALID_ARG_TYPE: p, ERR_INVALID_RETURN_VALUE: b }
            } = e("../../ours/errors"),
            { destroyer: g } = e("./destroy"),
            m = e("./duplex"),
            y = e("./readable"),
            { createDeferredPromise: _ } = e("../../ours/util"),
            w = e("./from"),
            v = globalThis.Blob || i.Blob,
            S =
              void 0 !== v
                ? function (e) {
            ...
            E =
              ...
              e("abort-controller").AbortController,
          ...
          function T(e) {
            ...
            return (
              ...
              (u._destroy = function (e, s) {
                (e || null === l || (e = new d()),
                  (a = null),
                  (n = null),
                  (i = null),
                  null === l ? s(e) : ((l = s), g(r, e), g(t, e)));
              }),
              u
            );
          }
          t.exports = function e(t, r) {
            ...
            if (c(t)) return T({ writable: t });
            if (l(t)) return T({ writable: !1, readable: !1 });
            if ("function" == typeof t) {
              const {
                value: e,
                write: i,
                  ...
                  o = e(
                    (async function* () {
                      for (;;) {
                        const e = t;
                        t = null;
                        const { chunk: i, done: o, cb: a } = await e;
                        if ((n.nextTick(a), o)) return;
                        if (s.aborted) throw new d(void 0, { cause: s.reason });
            ...
            if (a(t)) return w(k, t, { objectMode: !0, writable: !1 });
            if (
            ...
            if ("function" == typeof i) {
              ...
              return (
                ...
                (e = new k({ objectMode: !0, writable: !1, read() {} }))
              );
            }
            throw new p(
              r,
      ...
      113: [
        function (e, t, r) {
          const n = e("process/"),
            { AbortError: i, codes: s } = e("../../ours/errors"),
            { ERR_INVALID_ARG_TYPE: o, ERR_STREAM_PREMATURE_CLOSE: a } = s,
            ...
            { Promise: p, PromisePrototypeThen: b } = e(
              "../../ours/primordials"
            ),
            {
              isClosed: g,
          ...
          function P(e, t, r) {
              ...
              return (function (e, t, r) {
                ...
                if (t.signal)
                  if (
                    ((o = () => {
                      ((s = !0),
                        r.call(e, new i(void 0, { cause: t.signal.reason })));
                    }),
                    t.signal.aborted)
                  )
                    n.nextTick(o);
                ...
                const a = (...t) => {
                  s || n.nextTick(() => r.apply(e, t));
                };
                return (b(e[O].promise, a, a), C);
              })(e, t, r);
            if (!I(e))
              throw new o(
                "stream",
            ...
            const p = null !== (s = t.readable) && void 0 !== s ? s : y(e),
              P = null !== (d = t.writable) && void 0 !== d ? d : E(e),
              x = e._writableState,
              M = e._readableState,
              B = () => {
                e.writable || N();
              };
            let L = R(e) && y(e) === p && E(e) === P,
              j = k(e, !1);
            const N = () => {
              ((j = !0),
                e.destroyed && (L = !1),
                (!L || (e.readable && !p)) && ((p && !U) || r.call(e)));
            };
            let U = w(e, !1);
            const D = () => {
                ((U = !0),
                  e.destroyed && (L = !1),
                  (!L || (e.writable && !P)) && ((P && !j) || r.call(e)));
              },
              F = t => {
                r.call(e, t);
              };
            ...
            (!(function (e) {
              ...
              ? P && !x && (e.on("end", B), e.on("close", B))
              : (e.on("complete", N),
                L || e.on("abort", q),
                e.req ? z() : e.on("request", z)),
              ...
              W
                ? n.nextTick(q)
                : (null != x && x.errorEmitted) || (null != M && M.errorEmitted)
                  ? L || n.nextTick(H)
                  : (p || (L && !m(e)) || (!j && !1 !== S(e))) &&
                      (P || (L && !S(e)) || (!U && !1 !== m(e)))
                    ? M && e.req && e.aborted && n.nextTick(H)
                    : n.nextTick(H));
            const V = () => {
              ((r = C),
            ...
            if (t.signal && !W) {
              const s = () => {
                const n = r;
                (V(), n.call(e, new i(void 0, { cause: t.signal.reason })));
              };
            ...
            (t.exports.finished = function (e, t) {
              ...
              return (
                ...
                null !== (r = t) &&
                  void 0 !== r &&
                  r.cleanup &&
                  (d(t.cleanup, "cleanup"), (n = t.cleanup)),
                new p((r, i) => {
                  const s = P(e, t, e => {
                    (n && s(), e ? i(e) : r());
                  });
      ...
      114: [
        function (e, t, r) {
          ...
          const n = e("process/"),
            ...
            { Buffer: a } = e("buffer"),
            { ERR_INVALID_ARG_TYPE: l, ERR_STREAM_NULL_VALUES: u } =
              e("../../ours/errors").codes;
          t.exports = function (e, t, r) {
            let c, h;
            ...
            if (t && t[s]) ((h = !0), (c = t[s]()));
              ...
              if (!t || !t[o]) throw new l("iterable", ["Iterable"], t);
              ((h = !1), (c = t[o]()));
            }
      ...
      115: [
        function (e, t, r) {
          "use strict";
          const { ArrayIsArray: n, ObjectSetPrototypeOf: i } = e(
              "../../ours/primordials"
            ),
            { EventEmitter: s } = e("events");
          function o(e) {
            s.call(this, e);
          }
          function a(e, t, r) {
        ...
        { "../../ours/primordials": 127, events: 49 }
      ],
      116: [
        function (e, t, r) {
          "use strict";
          const n =
            ...
            { finished: d } = e("./end-of-stream"),
            p = e("./compose"),
            { addAbortSignalNoValidate: b } = e("./add-abort-signal"),
            { isWritable: g, isNodeStream: m } = e("./utils"),
            {
          ...
          function R(e, t) {
            if ("function" != typeof e)
              throw new s("fn", ["Function", "AsyncFunction"], e);
            (null != t && h(t, "options"),
                ...
                try {
                  for (;;) {
                    for (; u.length > 0; ) {
                      ...
                      if (e === I) return;
                      if (c.aborted) throw new l();
                      (e !== T && (yield e), u.shift(), p && (p(), (p = null)));
                    }
                    await new S(e => {
                      d = e;
                    });
                  ...
                  (o.abort(), (b = !0), p && (p(), (p = null)));
                }
              }.call(this)
            );
          }
          async function O(e, t = void 0) {
            for await (const r of C.call(this, e, t)) return !0;
            return !1;
          }
          function C(e, t) {
            if ("function" != typeof e)
          ...
          ((t.exports.streamReturningOperators = {
            ...
            compose: function (e, t) {
              ...
              const r = p(this, e);
              return (null != t && t.signal && b(t.signal, r), r);
            }
          }),
            (t.exports.promiseReturningOperators = {
              ...
              reduce: async function (e, t, r) {
                var i;
                if ("function" != typeof e)
                  throw new s("reducer", ["Function", "AsyncFunction"], e);
                (null != r && h(r, "options"),
                  null != (null == r ? void 0 : r.signal) &&
                    u(r.signal, "options.signal"));
                ...
                if (
                  ...
                  const e = new l(void 0, { cause: r.signal.reason });
                  throw (
                    this.once("error", () => {}),
                    await d(this.destroy(e)),
                    e
                  );
                }
                const a = new n(),
              ...
              find: async function (e, t) {
                for await (const r of C.call(this, e, t)) return r;
              }
            }));
        },
        {
      ...
      117: [
        ...
        { "../../ours/primordials": 127, "./transform": 121 }
      ],
      118: [
        function (e, t, r) {
          const n = e("process/"),
            ...
            { validateFunction: y, validateAbortSignal: _ } =
              e("../validators"),
            {
              isIterable: w,
              isReadable: v,
          ...
          function P(e, t, r) {
            ...
            return {
              destroy: t => {
                n || ((n = !0), u.destroyer(e, t || new b("pipe")));
              },
              cleanup: a(e, { readable: t, writable: r }, e => {
                n = !e;
              })
            };
          }
          ...
          async function B(e, t, r, { end: n }) {
            A(t) && (t = t.writable);
            const i = t.getWriter();
            try {
              for await (const t of e)
                (await i.ready, i.write(t).catch(() => {}));
          ...
          function L(t, r, s) {
            if ((1 === t.length && i(t[0]) && (t = t[0]), t.length < 2))
              throw new p("streams");
            const o = new R(),
              a = o.signal,
              l = null == s ? void 0 : s.signal,
              u = [];
            function h() {
              N(new m());
            }
            let b, g;
            (_(l, "options.signal"),
              null == l || l.addEventListener("abort", h));
            const y = [];
            let I,
              C = 0;
            function L(e) {
            ...
            function N(e, t) {
              if (
                (!e ||
                  (b && "ERR_STREAM_PREMATURE_CLOSE" !== b.code) ||
                  (b = e),
                b || t)
              ) {
                for (; y.length; ) y.shift()(b);
                (null == l || l.removeEventListener("abort", h),
                  o.abort(),
                  t && (b || u.forEach(e => e()), n.nextTick(r, b, g)));
              }
            }
            for (let W = 0; W < t.length; W++) {
              const q = t[W],
                H = W < t.length - 1,
                z = W > 0,
                V = H || !1 !== (null == s ? void 0 : s.end),
                $ = W === t.length - 1;
              if (E(q)) {
                if (V) {
                  const { destroy: K, cleanup: G } = P(q, H, z);
                  (y.push(K), v(q) && $ && u.push(G));
                }
                function U(e) {
                  e &&
                    "AbortError" !== e.name &&
              ...
              if (0 === W)
                ...
                } else I = w(q) || S(q) || A(q) ? q : c.from(q);
              else if ("function" == typeof q) {
                var D;
                if (A(I))
                  I = x(null === (D = I) || void 0 === D ? void 0 : D.readable);
                else I = x(I);
                if (((I = q(I, { signal: a })), H)) {
                  if (!w(I, !0))
                    throw new d("AsyncIterable", `transform[${W - 1}]`, I);
                } else {
                  var F;
                  O || (O = e("./passthrough"));
                  const Q = new O({ objectMode: !0 }),
                    Y = null === (F = I) || void 0 === F ? void 0 : F.then;
                  if ("function" == typeof Y)
                    (C++,
                      Y.call(
                        ...
                        e => {
                          (Q.destroy(e), n.nextTick(L, e));
                        }
                      ));
                  else if (w(I, !0)) (C++, M(I, Q, L, { end: V }));
                  else {
                    if (!T(I) && !A(I))
                      throw new d("AsyncIterable or Promise", "destination", I);
                    {
                      const X = I.readable || I;
                      (C++, M(X, Q, L, { end: V }));
                    }
                  }
                  I = Q;
                  const { destroy: J, cleanup: Z } = P(I, !1, !0);
                  (y.push(J), $ && u.push(Z));
                }
              } else if (E(q)) {
                if (S(I)) {
                  C += 2;
                  const ee = j(I, q, L, { end: V });
                  v(q) && $ && u.push(ee);
                } else if (A(I) || T(I)) {
                  const te = I.readable || I;
                  (C++, M(te, q, L, { end: V }));
                } else {
                  if (!w(I))
                    throw new f(
                ...
                if (S(I)) (C++, B(x(I), q, L, { end: V }));
                else if (T(I) || w(I)) (C++, B(I, q, L, { end: V }));
                else {
                  if (!A(I))
                    throw new f(
                      "val",
                  ...
                  (C++, B(I.readable, q, L, { end: V }));
                }
                I = q;
              } else I = c.from(q);
            }
            return (
              ((null != a && a.aborted) || (null != l && l.aborted)) &&
                n.nextTick(h),
              I
            );
          }
          function j(e, t, r, { end: i }) {
            ...
            if (
              ...
              I(e) ? n.nextTick(o) : e.once("end", o);
            } else r();
            return (
              a(e, { readable: !0, writable: !1 }, t => {
            ...
            pipeline: function (...e) {
              return L(
                ...
                l(
                  (function (e) {
                    return (
                      y(e[e.length - 1], "streams[stream.length - 1]"),
                      e.pop()
                    );
                  })(e)
                )
      ...
      119: [
        function (e, t, r) {
          ...
          const { EventEmitter: b } = e("events"),
            { Stream: g, prependListener: m } = e("./legacy"),
            { Buffer: y } = e("buffer"),
            { addAbortSignal: _ } = e("./add-abort-signal"),
            w = e("./end-of-stream");
          let v = e("../../ours/util").debuglog("stream", e => {
            v = e;
          });
          const S = e("./buffer_list"),
            E = e("./destroy"),
            { getHighWaterMark: A, getDefaultHighWaterMark: k } = e("./state"),
            {
          ...
          function U(t, r, n) {
            ("boolean" != typeof n && (n = r instanceof e("./duplex")),
              ...
              n &&
                (this.objectMode =
                  this.objectMode || !(!t || !t.readableObjectMode)),
              (this.highWaterMark = t
                ? A(this, t, "readableHighWaterMark", n)
                : k(!1)),
              (this.buffer = new S()),
              (this.length = 0),
              (this.pipes = []),
          ...
          function D(t) {
            ...
            ((this._readableState = new U(t, this, r)),
              t &&
                ("function" == typeof t.read && (this._read = t.read),
                "function" == typeof t.destroy && (this._destroy = t.destroy),
                "function" == typeof t.construct &&
                  (this._construct = t.construct),
                t.signal && !r && _(t.signal, this)),
              g.call(this, t),
              E.construct(this, () => {
                this._readableState.needReadable &&
                  V(this, this._readableState);
              }));
          }
          function F(e, t, r, n) {
            ...
            if (
              (i.objectMode ||
                ("string" == typeof t
                  ? ((r = r || i.defaultEncoding),
                    i.encoding !== r &&
                      (n && i.encoding
                        ? (t = y.from(t, r).toString(i.encoding))
                        : ((t = y.from(t, r)), (r = ""))))
                  : t instanceof y
                    ? (r = "")
                    : g._isUint8Array(t)
              ...
              ((i.reading = !1),
                (function (e, t) {
                  if ((v("onEofChunk"), t.ended)) return;
                  if (t.decoder) {
              ...
              if (n)
                if (i.endEmitted) N(e, new P());
                else {
                  if (i.destroyed || i.errored) return !1;
                  W(e, i, t, !0);
                }
              else if (i.ended) N(e, new C());
              else {
                if (i.destroyed || i.errored) return !1;
                ((i.reading = !1),
                  i.decoder && !r
                    ? ((t = i.decoder.write(t)),
                      i.objectMode || 0 !== t.length ? W(e, i, t, !1) : V(e, i))
                    : W(e, i, t, !1));
              }
            else n || ((i.reading = !1), V(e, i));
          ...
          ((D.prototype.destroy = E.destroy),
            (D.prototype._undestroy = E.undestroy),
            (D.prototype._destroy = function (e, t) {
              t(e);
            }),
            (D.prototype[b.captureRejectionSymbol] = function (e) {
              this.destroy(e);
            }),
            (D.prototype.push = function (e, t) {
              return F(this, e, t, !1);
            }),
            (D.prototype.unshift = function (e, t) {
              return F(this, e, t, !0);
            }),
          ...
          function V(e, t) {
            !t.readingMore &&
              t.constructed &&
              ((t.readingMore = !0), n.nextTick($, e, t));
          }
          function $(e, t) {
            for (
              ;
          ...
          function J(e, t) {
            "function" != typeof e.read && (e = D.wrap(e, { objectMode: !0 }));
            const r = (async function* (e, t) {
              ...
              e.on("readable", i);
              const s = w(e, { writable: !1 }, e => {
                ((r = e ? T(r, e) : null), n(), (n = j));
              });
              try {
                for (;;) {
          ...
          function X(e) {
            ...
            (v("endReadable", t.endEmitted),
              t.endEmitted || ((t.ended = !0), n.nextTick(ee, t, e)));
          }
          function ee(e, t) {
            if (
          ...
          ((D.prototype.read = function (e) {
            (v("read", e), void 0 === e ? (e = NaN) : s(e) || (e = a(e, 10)));
            ...
            if (
              ...
              return (
                ...
                0 === t.length && t.ended ? X(this) : H(this),
                null
              );
            if (0 === (e = q(e, t)) && t.ended)
            ...
            if (
              (v("need readable", i),
              (0 === t.length || t.length - e < t.highWaterMark) &&
                ((i = !0), v("length less than watermark", i)),
              t.ended ||
                t.reading ||
                t.destroyed ||
                t.errored ||
              ...
              ((i = !1), v("reading, ended or constructing", i));
            else if (i) {
              (v("do read"),
                (t.reading = !0),
                (t.sync = !0),
            ...
            (D.prototype.pipe = function (e, t) {
              ...
              (1 === i.pipes.length &&
                (i.multiAwaitDrain ||
                  ((i.multiAwaitDrain = !0),
                  (i.awaitDrainWriters = new f(
                    i.awaitDrainWriters ? [i.awaitDrainWriters] : []
                  )))),
                i.pipes.push(e),
                v("pipe count=%d opts=%j", i.pipes.length, t));
              const s =
                    ...
                    ((l = (function (e, t) {
                      return function () {
                        ...
                        (r.awaitDrainWriters === t
                          ? (v("pipeOnDrain", 1), (r.awaitDrainWriters = null))
                          : r.multiAwaitDrain &&
                            (v("pipeOnDrain", r.awaitDrainWriters.size),
              ...
              function d(t) {
                if (
                  ...
                  r && !r.errorEmitted ? N(e, t) : e.emit("error", t);
                }
              }
              function p() {
                (e.removeListener("finish", b), g());
              ...
              function b() {
                (v("onfinish"), e.removeListener("close", p), g());
              }
              function g() {
                (v("unpipe"), r.unpipe(e));
              }
                ...
                "data" === e
                  ...
                  : "readable" === e &&
                    (i.endEmitted ||
                      ...
                      (i.flowing = !1),
                      (i.emittedReadable = !1),
                      v("on readable", i.length, i.reading),
            ...
            (D.prototype.removeAllListeners = function (e) {
              ...
              return (
                ("readable" !== e && void 0 !== e) || n.nextTick(K, this),
                t
              );
            }),
            (D.prototype.resume = function () {
              ...
              return (
                e.flowing ||
                  ...
                  (function (e, t) {
                    t.resumeScheduled ||
                      ((t.resumeScheduled = !0), n.nextTick(Q, e, t));
                  })(this, e)),
                (e[M] = !1),
                this
              );
            ...
            (D.prototype.iterator = function (e) {
              return (void 0 !== e && x(e, "options"), J(this, e));
            }),
            l(D.prototype, {
              readable: {
                __proto__: null,
              ...
              readableObjectMode: {
                ...
                get() {
                  return (
                    !!this._readableState && this._readableState.objectMode
                  );
                }
              },
              readableEncoding: {
      ...
      120: [
        function (e, t, r) {
          "use strict";
          const { MathFloor: n, NumberIsInteger: i } = e(
              "../../ours/primordials"
            ),
          ...
          t.exports = {
            getHighWaterMark: function (e, t, r, a) {
              ...
              if (null != l) {
                if (!i(l) || l < 0) {
                  throw new s(a ? `options.${r}` : "options.highWaterMark", l);
                }
                return n(l);
              }
              return o(e.objectMode);
            },
            getDefaultHighWaterMark: o
          };
        },
        { "../../ours/errors": 126, "../../ours/primordials": 127 }
      ],
      121: [
        function (e, t, r) {
          "use strict";
          const { ObjectSetPrototypeOf: n, Symbol: i } = e(
            "../../ours/primordials"
          );
          t.exports = u;
          const { ERR_METHOD_NOT_IMPLEMENTED: s } =
              e("../../ours/errors").codes,
            o = e("./duplex"),
      ...
      122: [
        function (e, t, r) {
          ...
          const {
            ...
            u = n("kIsReadable"),
            c = n("kIsDisturbed"),
            h = o("nodejs.webstream.isClosedPromise"),
          ...
          t.exports = {
                              ...
                              (i =
                                null !==
                                  (s =
                                    null !== (o = e[l]) && void 0 !== o
                                      ? o
                                      : e.readableErrored) && void 0 !== s
                                  ? s
                                  : e.writableErrored) && void 0 !== i
                              ? i
                              : null === (a = e._readableState) || void 0 === a
                                ? void 0
                                : a.errorEmitted) && void 0 !== n
                          ? n
                          : null === (u = e._writableState) || void 0 === u
                            ? void 0
                            : u.errorEmitted) && void 0 !== r
                      ? r
            ...
            isFinished: function (e, t) {
              return b(e)
                ? !!_(e) ||
                    ((!1 === (null == t ? void 0 : t.readable) || !S(e)) &&
                      (!1 === (null == t ? void 0 : t.writable) || !E(e)))
                : null;
            },
            isIterable: function (e, t) {
              return (
                ...
                (!0 === t
                  ...
                  : !1 === t
                    ? "function" == typeof e[s]
                    : "function" == typeof e[i] || "function" == typeof e[s])
              );
            },
      ...
      123: [
        function (e, t, r) {
          ...
          const { EventEmitter: d } = e("events"),
            ...
            { Buffer: b } = e("buffer"),
            g = e("./destroy"),
            { addAbortSignal: m } = e("./add-abort-signal"),
            { getHighWaterMark: y, getDefaultHighWaterMark: _ } = e("./state"),
            {
              ERR_INVALID_ARG_TYPE: w,
              ERR_METHOD_NOT_IMPLEMENTED: v,
              ERR_MULTIPLE_CALLBACK: S,
              ERR_STREAM_CANNOT_PIPE: E,
          ...
          function x(t, r, n) {
            ("boolean" != typeof n && (n = r instanceof e("./duplex")),
              ...
              n &&
                (this.objectMode =
                  this.objectMode || !(!t || !t.writableObjectMode)),
              (this.highWaterMark = t
                ? y(this, t, "writableHighWaterMark", n)
                : _(!1)),
              (this.finalCalled = !1),
              (this.needDrain = !1),
              (this.ending = !1),
          ...
          function B(t) {
            ...
            ((this._writableState = new x(t, this, r)),
              t &&
                ...
                "function" == typeof t.construct &&
                  (this._construct = t.construct),
                t.signal && m(t.signal, this)),
              p.call(this, t),
              g.construct(this, () => {
                const e = this._writableState;
                (e.writing || q(this, e), V(this, e));
              }));
          }
          function L(e, t, r, i) {
            const s = e._writableState;
            if ("function" == typeof r) ((i = r), (r = s.defaultEncoding));
            else {
              if (r) {
                if ("buffer" !== r && !b.isEncoding(r)) throw new R(r);
              } else r = s.defaultEncoding;
              "function" != typeof i && (i = C);
            }
            if (null === t) throw new T();
            if (!s.objectMode)
              if ("string" == typeof t)
                !1 !== s.decodeStrings && ((t = b.from(t, r)), (r = "buffer"));
            ...
            let o;
            return (
              s.ending ? (o = new I()) : s.destroyed && (o = new A("write")),
              o
                ? (n.nextTick(i, o), O(e, o, !0), o)
                : (s.pendingcb++,
                  (function (e, t, r, n, i) {
                    const s = t.objectMode ? 1 : r.length;
                    t.length += s;
                    const o = t.length < t.highWaterMark;
                    o || (t.needDrain = !0);
              ...
              ? ((r.writing = !1),
                ...
                t
                  ? (t.stack,
                    ...
                    i ? n.nextTick(N, e, r, t, s) : N(e, r, t, s))
                  : (r.buffered.length > r.bufferedIndex && q(e, r),
                    i
                      ? null !== r.afterWriteTickInfo &&
                        r.afterWriteTickInfo.cb === s
                        ...
                        : ((r.afterWriteTickInfo = {
                          ...
                          n.nextTick(D, r.afterWriteTickInfo))
                      : F(e, r, 1, s)))
              : O(e, new S());
          }
          function D({ stream: e, state: t, count: r, cb: n }) {
          ...
          function W(e) {
            ...
            for (let r = e.bufferedIndex; r < e.buffered.length; ++r) {
              ...
              const { chunk: n, callback: i } = e.buffered[r],
                s = e.objectMode ? 1 : n.length;
              ((e.length -= s),
                i(
                  null !== (t = e.errored) && void 0 !== t ? t : new A("write")
                ));
            }
          ...
          function q(e, t) {
            if (t.corked || t.bufferProcessing || t.destroyed || !t.constructed)
              return;
            const { buffered: r, bufferedIndex: n, objectMode: s } = t,
              o = r.length - n;
            if (!o) return;
            let a = n;
            if (((t.bufferProcessing = !0), o > 1 && e._writev)) {
              ...
              ((s.allBuffers = t.allBuffers),
                j(e, t, !0, t.length, s, "", n),
                M(t));
            } else {
              do {
                const { chunk: n, encoding: i, callback: o } = r[a];
                r[a++] = null;
                j(e, t, !1, s ? 1 : n.length, n, i, o);
          ...
          ((x.prototype.getBuffer = function () {
            ...
            a(B, f, {
              ...
              value: function (e) {
                return (
                  !!o(this, e) ||
                  (this === B && e && e._writableState instanceof x)
                );
              }
            }),
            ...
            (B.prototype.uncork = function () {
              const e = this._writableState;
              e.corked && (e.corked--, e.writing || q(this, e));
            }),
            (B.prototype.setDefaultEncoding = function (e) {
              if (("string" == typeof e && (e = c(e)), !b.isEncoding(e)))
                throw new R(e);
              return ((this._writableState.defaultEncoding = e), this);
            }),
            (B.prototype._write = function (e, t, r) {
              if (!this._writev) throw new v("_write()");
              ...
              return (
                ...
                o ||
                  (i.errored || i.ending
                    ? i.finished
                      ? (o = new k("end"))
                      : i.destroyed && (o = new A("end"))
                    : ((i.ending = !0), V(this, i, !0), (i.ended = !0))),
                "function" == typeof r &&
                  (o || i.finished ? n.nextTick(r, o) : i[P].push(r)),
                this
              );
            }),
            l(B.prototype, {
              ...
              writableObjectMode: {
                ...
                get() {
                  return (
                    !!this._writableState && this._writableState.objectMode
                  );
                }
              },
              writableBuffer: {
              ...
              writableHighWaterMark: {
                ...
                get() {
                  return (
                    this._writableState && this._writableState.highWaterMark
                  );
                }
              },
              writableCorked: {
          ...
          ((B.prototype.destroy = function (e, t) {
            const r = this._writableState;
            return (
              !r.destroyed &&
                (r.bufferedIndex < r.buffered.length || r[P].length) &&
                n.nextTick(W, r),
              K.call(this, e, t),
              this
            );
            ...
            (B.prototype[d.captureRejectionSymbol] = function (e) {
              this.destroy(e);
            }),
      ...
      124: [
        function (e, t, r) {
          ...
          const {
            ...
            { normalizeEncoding: E } = e("../ours/util"),
            { isAsyncFunction: A, isArrayBufferView: k } =
              e("../ours/util").types,
            T = {};
          const I = /^[0-7]+$/;
          const R = m((e, t, r = c, n = u) => {
              if ("number" != typeof e) throw new _(t, "number", e);
              if (!a(e)) throw new v(t, "an integer", e);
              if (e < r || e > n) throw new v(t, `>= ${r} && <= ${n}`, e);
            }),
            O = m((e, t, r = -2147483648, n = 2147483647) => {
              if ("number" != typeof e) throw new _(t, "number", e);
              if (!a(e)) throw new v(t, "an integer", e);
              if (e < r || e > n) throw new v(t, `>= ${r} && <= ${n}`, e);
            }),
            C = m((e, t, r = !1) => {
              ...
              const n = r ? 1 : 0,
                i = 4294967295;
              if (e < n || e > i) throw new v(t, `>= ${n} && <= ${i}`, e);
            });
          function P(e, t) {
          ...
          const L = m((e, t, r = null) => {
              const i = B(r, "allowArray", !1),
                s = B(r, "allowFunction", !1);
              if (
                (!B(r, "nullable", !1) && null === e) ||
                (!i && n(e)) ||
                ("object" != typeof e && (!s || "function" != typeof e))
              )
          ...
          const U = m((e, t = "buffer") => {
            if (!k(e)) throw new _(t, ["Buffer", "TypedArray", "DataView"], e);
          });
          const D = m((e, t) => {
              if (
                void 0 !== e &&
          ...
          t.exports = {
            ...
            validateBooleanArray: function (e, t) {
              N(e, t);
              for (let r = 0; r < e.length; r++) M(e[r], `${t}[${r}]`);
            },
            validateBoolean: M,
            validateBuffer: U,
            ...
            validateEncoding: function (e, t) {
              ...
              if ("hex" === r && n % 2 != 0)
                throw new w(
                  "encoding",
                  t,
                  `is invalid for data of length ${n}`
                );
            },
            validateFunction: F,
            validateInt32: O,
            ...
            validateNumber: function (e, t, r = void 0, n) {
              ...
              if (
                ...
                throw new v(
                  t,
                  `${null != r ? `>= ${r}` : ""}${null != r && null != n ? " && " : ""}${null != n ? `<= ${n}` : ""}`,
                  e
                );
            },
            validateObject: L,
            ...
            validateUnion: function (e, t, r) {
              if (!i(r, e)) throw new _(t, `('${s(r, "|")}')`, e);
            },
            validateAbortSignal: D,
            validateLinkHeaderValue: function (e) {
              if ("string" == typeof e) return (z(e, "hints"), e);
              if (n(e)) {
                const t = e.length;
                let r = "";
                if (0 === t) return r;
      ...
      125: [
        ...
        { "../stream": 129, "../stream/promises": 130 }
      ],
      126: [
        function (e, t, r) {
          "use strict";
          const { format: n, inspect: i, AggregateError: s } = e("./util"),
            o = globalThis.AggregateError || s,
          ...
          (d("ERR_ASSERTION", "%s", Error),
            d(
              "ERR_INVALID_ARG_TYPE",
              (e, t, r) => {
                (h("string" == typeof e, "'name' must be a string"),
                  Array.isArray(t) || (t = [t]));
                let n = "The ";
                (e.endsWith(" argument")
                  ? (n += `${e} `)
            ...
            d(
              ...
              (...e) => {
                let t;
                h(e.length > 0, "At least one arg needs to be specified");
                const r = e.length;
                switch (
          ...
          ((t.exports = {
            ...
            format: (e, ...t) =>
              e.replace(/%([sdifj])/g, function (...[e, r]) {
                const n = t.shift();
                if ("f" === r) return n.toFixed(6);
                if ("j" === r) return JSON.stringify(n);
      ...
      129: [
        function (e, t, r) {
          const { Buffer: n } = e("buffer"),
            ...
            { streamReturningOperators: l, promiseReturningOperators: u } = e(
              "./internal/streams/operators"
            ),
            {
              codes: { ERR_ILLEGAL_CONSTRUCTOR: c }
            } = e("./ours/errors"),
            h = e("./internal/streams/compose"),
            { pipeline: f } = e("./internal/streams/pipeline"),
            { destroyer: d } = e("./internal/streams/destroy"),
            p = e("./internal/streams/end-of-stream"),
            b = e("./stream/promises"),
            g = e("./internal/streams/utils"),
            m = (t.exports = e("./internal/streams/legacy").Stream);
          ((m.isDisturbed = g.isDisturbed),
            (m.isErrored = g.isErrored),
            (m.isReadable = g.isReadable),
            (m.Readable = e("./internal/streams/readable")));
          for (const w of s(l)) {
            const v = l[w];
            function y(...e) {
              if (new.target) throw c();
              return m.Readable.from(o(v, this, e));
            }
            (i(y, "name", { __proto__: null, value: v.name }),
              i(y, "length", { __proto__: null, value: v.length }),
              i(m.Readable.prototype, w, {
                __proto__: null,
                value: y,
                enumerable: !1,
                configurable: !0,
          ...
          for (const S of s(u)) {
            ...
            (i(y, "name", { __proto__: null, value: E.name }),
              i(y, "length", { __proto__: null, value: E.length }),
              i(m.Readable.prototype, S, {
                __proto__: null,
                value: y,
                enumerable: !1,
                configurable: !0,
          ...
          ((m.Writable = e("./internal/streams/writable")),
            (m.Duplex = e("./internal/streams/duplex")),
            (m.Transform = e("./internal/streams/transform")),
            (m.PassThrough = e("./internal/streams/passthrough")),
            (m.pipeline = f));
          const { addAbortSignal: _ } = e(
          ...
          ((m.addAbortSignal = _),
            ...
            i(f, a, { __proto__: null, enumerable: !0, get: () => b.pipeline }),
            i(p, a, { __proto__: null, enumerable: !0, get: () => b.finished }),
            (m.Stream = m),
            (m._isUint8Array = function (e) {
              return e instanceof Uint8Array;
            }),
            (m._uint8ArrayToBuffer = function (e) {
              return n.from(e.buffer, e.byteOffset, e.byteLength);
            }));
        },
        {
          "./internal/streams/add-abort-signal": 107,
          "./internal/streams/compose": 109,
          "./internal/streams/destroy": 110,
          "./internal/streams/duplex": 111,
          "./internal/streams/end-of-stream": 113,
          "./internal/streams/legacy": 115,
          "./internal/streams/operators": 116,
          "./internal/streams/passthrough": 117,
          "./internal/streams/pipeline": 118,
          "./internal/streams/readable": 119,
          "./internal/streams/transform": 121,
          "./internal/streams/utils": 122,
          "./internal/streams/writable": 123,
          "./ours/errors": 126,
          "./ours/primordials": 127,
          "./ours/util": 128,
          "./stream/promises": 130,
          ...
          (function (e) {
            (function () {
              ...
              t.exports = function (e) {
                return (e = e || {}).circles
                  ? (function (e) {
                      ...
                      return e.proto
                        ? function e(s) {
                            ...
                            if (Array.isArray(s)) return i(s, e);
                            if (s instanceof Map)
                              return new Map(i(Array.from(s), e));
                            if (s instanceof Set)
                              return new Set(i(Array.from(s), e));
                            var o = {};
                            for (var a in (t.push(s), n.push(o), s)) {
                              var l = s[a];
                              if ("object" != typeof l || null === l) o[a] = l;
                              else if (l instanceof Date) o[a] = new Date(l);
                              else if (l instanceof Map)
                                o[a] = new Map(i(Array.from(l), e));
                              else if (l instanceof Set)
                                o[a] = new Set(i(Array.from(l), e));
                      ...
                      function i(e, i) {
                        for (
                          ...
                          var l = s[a],
                            u = e[l];
                          if ("object" != typeof u || null === u) o[l] = u;
                          else if (u instanceof Date) o[l] = new Date(u);
                          else if (ArrayBuffer.isView(u)) o[l] = r(u);
                          else {
                            var c = t.indexOf(u);
                            o[l] = -1 !== c ? n[c] : i(u);
                          }
                  ...
                  : e.proto
                        ...
                        for (var s in n) {
                          ...
                          "object" != typeof o || null === o
                            ...
                            : o instanceof Date
                              ? (i[s] = new Date(o))
                              : o instanceof Map
                                ? (i[s] = new Map(t(Array.from(o), e)))
                                : o instanceof Set
                                  ? (i[s] = new Set(t(Array.from(o), e)))
                    ...
                    : function e(n) {
                        ...
                        var i = {};
                        for (var s in n)
                          if (!1 !== Object.hasOwnProperty.call(n, s)) {
                            var o = n[s];
                            "object" != typeof o || null === o
                              ? (i[s] = o)
                              : o instanceof Date
                ...
                function t(e, t) {
                  for (
                    var n = Object.keys(e), i = new Array(n.length), s = 0;
                    s < n.length;
                    s++
                  ) {
                    var o = n[s],
      ...
      137: [
        function (e, t, r) {
          ...
          ((s.prototype.parse = function (e, t, r) {
            ...
            if (r || v || _.match(/^\/\/[^@\/]+@[^@\/]+/)) {
              var E = "//" === _.substr(0, 2);
              !E || (v && g[v]) || ((_ = _.substr(2)), (this.slashes = !0));
            }
            if (!g[v] && (E || (v && !m[v]))) {
              for (var A, k, T = -1, I = 0; I < f.length; I++) {
                -1 !== (R = _.indexOf(f[I])) && (-1 === T || R < T) && (T = R);
              }
              (-1 !==
                (k = -1 === T ? _.lastIndexOf("@") : _.lastIndexOf("@", T)) &&
                ((A = _.slice(0, k)),
                (_ = _.slice(k + 1)),
              ...
              for (I = 0; I < h.length; I++) {
                var R;
                -1 !== (R = _.indexOf(h[I])) && (-1 === T || R < T) && (T = R);
              }
              (-1 === T && (T = _.length),
                (this.host = _.slice(0, T)),
                (_ = _.slice(T)),
                this.parseHost(),
              ...
              if (!O)
                for (
                  var C = this.hostname.split(/\./), P = ((I = 0), C.length);
                  I < P;
                  I++
                ) {
                  var x = C[I];
            ...
            if (!b[S])
              for (I = 0, P = c.length; I < P; I++) {
                ...
                if (-1 !== _.indexOf(W)) {
                  ...
                  (q === W && (q = escape(W)), (_ = _.split(W).join(q)));
                }
              }
            var H = _.indexOf("#");
            ...
            (s.prototype.resolveObject = function (e) {
              ...
              for (
                var r = new s(), n = Object.keys(this), o = 0;
                o < n.length;
                o++
              ) {
                var a = n[o];
        ...
        { "./util": 138, punycode: 103, querystring: 106 }
      ],
      138: [
        function (e, t, r) {
          "use strict";
